...
*/
public class SubReportParameters  extends ReportLink 
{
    List<SubreportParameter> _Items = new List<SubreportParameter>();
    // list of SubreportParameter
    public SubReportParameters(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
    ...
    public void finalPass() throws Exception {
        ...
        {
            SubreportParameter rp = (SubreportParameter)__dummyForeachVar1;
            rp.finalPass();
        }
        return ;
    }

    public List<SubreportParameter> getItems() throws Exception {
        return _Items;
    }
