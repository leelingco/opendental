...
*/
public class Corner  extends ReportLink 
{
    ReportItems _ReportItems;
    // The region that contains the elements of the corner layout
    ...
    public Corner(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        _ReportItems = null;
