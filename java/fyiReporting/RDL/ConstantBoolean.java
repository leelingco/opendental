...
* Boolean constant
*/
public class ConstantBoolean   implements IExpr
{
    boolean _Value = new boolean();
    // value of the constant
    /**
    * A boolean constant: i.e. true or false.
    */
    public ConstantBoolean(String v) throws Exception {
        _Value = Convert.ToBoolean(v);
    }

    public ConstantBoolean(boolean v) throws Exception {
        _Value = v;
    }
