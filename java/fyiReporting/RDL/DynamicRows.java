...
*/
public class DynamicRows  extends ReportLink 
{
    Grouping _Grouping;
    ...
    Subtotal _Subtotal;
    // Indicates an automatic subtotal row should be included
    ReportItems _ReportItems;
    // The elements of the row header layout
    ...
    // Indicates if all of the dynamic rows for this grouping
    // should be hidden and replaced with a subtotal row for
    // this grouping scope
    public DynamicRows(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        _Grouping = null;
        _Sorting = null;
        _Subtotal = null;
