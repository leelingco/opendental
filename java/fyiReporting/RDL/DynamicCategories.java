...
*/
public class DynamicCategories  extends ReportLink 
{
    Grouping _Grouping;
    ...
    Expression _Label;
    //(Variant) The label displayed on the axis.
    public DynamicCategories(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        _Grouping = null;
        _Sorting = null;
        _Label = null;
