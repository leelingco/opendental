...
*/
public class FunctionAggrSum  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    * other expressions.
    */
    public FunctionAggrSum(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
        RefSupport refVar___0 = new RefSupport(Parser.Counter);
        _key = "aggrsum" + Interlocked.Increment(refVar___0).ToString();
