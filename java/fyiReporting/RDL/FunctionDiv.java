...
*/
public class FunctionDiv  extends FunctionBinary implements IExpr
{
    /**
    * Do division on double data types
    */
    public FunctionDiv() throws Exception {
    }

    public FunctionDiv(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
