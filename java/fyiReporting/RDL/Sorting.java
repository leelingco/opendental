...
*/
public class Sorting  extends ReportLink 
{
    List<SortBy> _Items = new List<SortBy>();
    // list of SortBy
    public Sorting(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        SortBy s;
        ...
        for (Object __dummyForeachVar0 : xNode.ChildNodes)
        {
            ...
            if (__dummyScrutVar0.equals("SortBy"))
            {
    ...
    public void finalPass() throws Exception {
        ...
        {
            SortBy s = (SortBy)__dummyForeachVar1;
            s.finalPass();
        }
        return ;
    }

    public List<SortBy> getItems() throws Exception {
        return _Items;
    }
