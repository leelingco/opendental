...
*/
public class FunctionAggrRvSum  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    * other expressions.
    */
    public FunctionAggrRvSum(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
        RefSupport refVar___0 = new RefSupport(Parser.Counter);
        _key = "aggrrvsum" + Interlocked.Increment(refVar___0).ToString();
