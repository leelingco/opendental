...
*/
public class FunctionAggrCountRows  extends FunctionAggr implements IExpr
{
    /**
    * Aggregate function: CountRows
    * 
    ...
    */
    public FunctionAggrCountRows(Object scp) throws Exception {
        super(null, scp);
    }
    ...
    public double evaluateDouble(fyiReporting.RDL.Report rpt, Row row) throws Exception {
        ...
        RowEnumerable re = this.getDataScope(rpt,row,refVar___0);
        bSave = refVar___0.getValue();
        if (re == null)
            return 0;
         
        int count = re.getLastRow() - re.getFirstRow() + 1;
        return count;
    }
