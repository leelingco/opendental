...
*/
public class FunctionAggrFirst  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    */
    public FunctionAggrFirst(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
    ...
    public Object evaluate(fyiReporting.RDL.Report rpt, Row row) throws Exception {
        ...
        if (v == null)
        {
            ...
            if (re.getData().Count > 0)
                saver = re.getData()[re.getFirstRow()] instanceof Row ? (Row)re.getData()[re.getFirstRow()] : (Row)null;
