...
*/
public class FunctionPlus  extends FunctionBinary implements IExpr
{
    /**
    * Do plus on double data types
    */
    public FunctionPlus() throws Exception {
    }

    public FunctionPlus(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
