...
*/
public class FunctionUserLanguage   implements IExpr
{
    /**
    * Client user language
    */
    public FunctionUserLanguage() throws Exception {
    }
    ...
    public String evaluateString(fyiReporting.RDL.Report rpt, Row row) throws Exception {
        if (rpt == null || rpt.getClientLanguage() == null)
            return CultureInfo.CurrentCulture.ThreeLetterISOLanguageName;
        else
            return rpt.getClientLanguage(); 
    }
