...
*/
public class StaticRows  extends ReportLink 
{
    List<StaticRow> _Items = new List<StaticRow>();
    // list of StaticRow
    public StaticRows(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        StaticRow sr;
        ...
        for (Object __dummyForeachVar0 : xNode.ChildNodes)
        {
            ...
            if (__dummyScrutVar0.equals("StaticRow"))
            {
    ...
    public void finalPass() throws Exception {
        ...
        {
            StaticRow r = (StaticRow)__dummyForeachVar1;
            r.finalPass();
        }
        return ;
    }

    public List<StaticRow> getItems() throws Exception {
        return _Items;
    }
