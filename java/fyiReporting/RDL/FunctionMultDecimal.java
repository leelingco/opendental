...
*/
public class FunctionMultDecimal  extends FunctionBinary implements IExpr
{
    /**
    * Do multiplication on decimal data types
    */
    public FunctionMultDecimal() throws Exception {
        _lhs = null;
        _rhs = null;
    }

    public FunctionMultDecimal(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
