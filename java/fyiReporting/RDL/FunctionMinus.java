...
*/
public class FunctionMinus  extends FunctionBinary implements IExpr
{
    /**
    * Do minus on double data types
    */
    public FunctionMinus() throws Exception {
        _lhs = null;
        _rhs = null;
    }

    public FunctionMinus(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
