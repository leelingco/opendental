...
*/
public class ValueAxis  extends ReportLink 
{
    Axis _Axis;
    // Display properties for the value axis.
    public ValueAxis(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        _Axis = null;
