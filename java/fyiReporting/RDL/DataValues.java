...
*/
public class DataValues  extends ReportLink 
{
    List<DataValue> _Items = new List<DataValue>();
    // list of DataValue
    public DataValues(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        DataValue dv;
        ...
        for (Object __dummyForeachVar0 : xNode.ChildNodes)
        {
            ...
            if (__dummyScrutVar0.equals("DataValue"))
            {
    ...
    public List<DataValue> getItems() throws Exception {
        return _Items;
    }
