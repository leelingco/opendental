...
*/
public class FunctionExp  extends FunctionBinary implements IExpr
{
    /**
    * Do exponentiation on double data types
    */
    public FunctionExp() throws Exception {
    }

    public FunctionExp(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
