...
*/
public class FunctionMinusDecimal  extends FunctionBinary implements IExpr
{
    /**
    * Do minus on decimal data types
    */
    public FunctionMinusDecimal() throws Exception {
        _lhs = null;
        _rhs = null;
    }

    public FunctionMinusDecimal(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
