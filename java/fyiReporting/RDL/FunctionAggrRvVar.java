...
*/
public class FunctionAggrRvVar  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    */
    public FunctionAggrRvVar(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
        RefSupport refVar___0 = new RefSupport(Parser.Counter);
        _key = "aggrrvvar" + Interlocked.Increment(refVar___0).ToString();
