...
* Constant decimal.
*/
public class ConstantDecimal   implements IExpr
{
    double _Value = new double();
    // value of the constant
    /**
    * passed string of the number
    */
    public ConstantDecimal(String v) throws Exception {
        _Value = Convert.ToDecimal(v, NumberFormatInfo.InvariantInfo);
    }

    public ConstantDecimal(double v) throws Exception {
        _Value = v;
    }
