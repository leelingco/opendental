...
*/
public class FunctionAggrCount  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    */
    public FunctionAggrCount(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
