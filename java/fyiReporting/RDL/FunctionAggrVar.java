...
*/
public class FunctionAggrVar  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    */
    public FunctionAggrVar(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
