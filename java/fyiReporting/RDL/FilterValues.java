...
* filter operater.
*/
public class FilterValues  extends ReportLink 
{
    List<FilterValue> _Items = new List<FilterValue>();
    // list of FilterValue
    public FilterValues(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        FilterValue f;
        ...
        for (Object __dummyForeachVar0 : xNode.ChildNodes)
        {
            ...
            if (__dummyScrutVar0.equals("FilterValue"))
            {
    ...
    public void finalPass() throws Exception {
        ...
        {
            FilterValue f = (FilterValue)__dummyForeachVar1;
            f.finalPass();
        }
        return ;
    }

    public List<FilterValue> getItems() throws Exception {
        return _Items;
    }
