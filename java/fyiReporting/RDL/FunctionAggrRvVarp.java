...
*/
public class FunctionAggrRvVarp  extends FunctionAggr implements IExpr, ICacheData
{
    String _key = new String();
    // key for cache of data between invocations
    /**
    ...
    */
    public FunctionAggrRvVarp(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
        RefSupport refVar___0 = new RefSupport(Parser.Counter);
        _key = "aggrrvstvarp" + Interlocked.Increment(refVar___0).ToString();
