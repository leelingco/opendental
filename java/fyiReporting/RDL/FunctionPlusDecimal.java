...
*/
public class FunctionPlusDecimal  extends FunctionBinary implements IExpr
{
    /**
    * Do plus on decimal data types
    */
    public FunctionPlusDecimal() throws Exception {
    }

    public FunctionPlusDecimal(IExpr lhs, IExpr rhs) throws Exception {
        _lhs = lhs;
        _rhs = rhs;
    }
