...
*/
public class FunctionAggrNext  extends FunctionAggr implements IExpr, ICacheData
{
    ...
    */
    public FunctionAggrNext(List<ICacheData> dataCache, IExpr e, Object scp) throws Exception {
        super(e, scp);
        RefSupport refVar___0 = new RefSupport(Parser.Counter);
        _key = "aggrnext" + Interlocked.Increment(refVar___0).ToString();
