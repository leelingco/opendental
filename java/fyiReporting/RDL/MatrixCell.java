...
*/
public class MatrixCell  extends ReportLink 
{
    ReportItems _ReportItems;
    // The report items contained in each detail cell of the matrix layout.
    ...
    public MatrixCell(ReportDefn r, ReportLink p, XmlNode xNode) throws Exception {
        super(r, p);
        _ReportItems = null;
