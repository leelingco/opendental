...
*/
public class DialogNewTable  extends System.Windows.Forms.Form 
{
    ...
    private System.Windows.Forms.CheckedListBox lbTableColumns = new System.Windows.Forms.CheckedListBox();
    ...
    private System.Windows.Forms.Button bRight = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bAllRight = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bLeft = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bAllLeft = new System.Windows.Forms.Button();
    private System.Windows.Forms.Label label4 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbGroupColumn = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.CheckBox chkGrandTotals = new System.Windows.Forms.CheckBox();
    private System.Windows.Forms.GroupBox groupBox1 = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.RadioButton rbHorz = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton rbVert = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton rbVertComp = new System.Windows.Forms.RadioButton();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    public DialogNewTable(DesignXmlDraw dxDraw, XmlNode container) throws Exception {
        _Draw = dxDraw;
        //
    ...
    public String getTableXml() throws Exception {
        return rbHorz.Checked ? getTableXmlHorz() : getTableXmlVert();
    }

    private String getTableXmlHorz() throws Exception {
        StringBuilder table = new StringBuilder("<Table>");
        table.AppendFormat("<DataSetName>{0}</DataSetName>", this.cbDataSets.Text);
        table.Append("<NoRows>Query returned no rows!</NoRows><Style>" + "<BorderStyle><Default>Solid</Default></BorderStyle></Style>");
        StringBuilder tablecolumns = new StringBuilder("<TableColumns>");
        StringBuilder headercolumns = new StringBuilder("<Header><TableRows><TableRow><Height>12 pt</Height><TableCells>");
        StringBuilder detailcolumns = new StringBuilder("<Details><TableRows><TableRow><Height>12 pt</Height><TableCells>");
        StringBuilder tablegroups = null;
        StringBuilder footergroup = null;
        String gname = this.cbGroupColumn.Text;
        if (gname != null && !StringSupport.equals(gname.Trim(), ""))
        {
            gname = gname.Trim();
            tablegroups = new StringBuilder("<TableGroups><TableGroup><Grouping><GroupExpressions><GroupExpression>");
            ...
            footergroup = new StringBuilder("<Footer><TableRows><TableRow><Height>12 pt</Height><TableCells>");
        }
        else
            gname = null; 
        StringBuilder footercolumns = null;
        if (this.chkGrandTotals.Checked)
            footercolumns = new StringBuilder("<Footer><TableRows><TableRow><Height>12 pt</Height><TableCells>");
         
        boolean bHaveFooter = false;
        for (Object __dummyForeachVar0 : this.lbTableColumns.Items)
        {
            // indicates one or more columns have been checked for subtotaling
            String colname = (String)__dummyForeachVar0;
            tablecolumns.Append("<TableColumn><Width>1in</Width></TableColumn>");
            headercolumns.AppendFormat("<TableCell><ReportItems><Textbox><Value>{0}</Value>" + "<Style><TextAlign>Center</TextAlign><BorderStyle><Default>Solid</Default></BorderStyle>" + "<FontWeight>Bold</FontWeight></Style>" + "</Textbox></ReportItems></TableCell>", colname);
            String dcol = new String();
            String gcol = new String();
            if (StringSupport.equals(gname, colname))
            {
                dcol = "";
            ...
            if (tablegroups != null)
            {
                tablegroups.AppendFormat("<TableCell><ReportItems><Textbox>" + "<Value>{0}</Value><CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>Solid</Default></BorderStyle>" + "</Style></Textbox></ReportItems></TableCell>", gcol);
                footergroup.AppendFormat("<TableCell><ReportItems><Textbox>" + "<Value>{0}</Value><CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>Solid</Default></BorderStyle>" + "</Style></Textbox></ReportItems></TableCell>", fcol);
            }
             
            detailcolumns.AppendFormat("<TableCell><ReportItems><Textbox>" + "<Value>{0}</Value><CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>Solid</Default></BorderStyle>" + "</Style></Textbox></ReportItems></TableCell>", dcol);
            if (footercolumns != null)
                footercolumns.AppendFormat("<TableCell><ReportItems><Textbox>" + "<Value>{0}</Value><CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>Solid</Default></BorderStyle>" + "</Style></Textbox></ReportItems></TableCell>", fcol);
             
        }
        tablecolumns.Append("</TableColumns>");
        table.Append(tablecolumns.ToString());
        headercolumns.Append("</TableCells></TableRow></TableRows>" + "<RepeatOnNewPage>true</RepeatOnNewPage></Header>");
        table.Append(headercolumns.ToString());
        detailcolumns.Append("</TableCells></TableRow></TableRows>" + "</Details>");
        table.Append(detailcolumns.ToString());
        if (footercolumns != null)
        {
            footercolumns.Append("</TableCells></TableRow></TableRows>" + "</Footer>");
            table.Append(footercolumns.ToString());
        }
         
        if (tablegroups != null)
        {
            tablegroups.Append("</TableCells></TableRow></TableRows>" + "</Header>");
            if (bHaveFooter)
            {
                footergroup.Append("</TableCells></TableRow></TableRows>" + "</Footer>");
    ...
    private String getTableXmlVert() throws Exception {
        StringBuilder table = new StringBuilder("<Table>");
        table.AppendFormat("<DataSetName>{0}</DataSetName>", this.cbDataSets.Text);
        table.Append("<NoRows>Query returned no rows!</NoRows><Style>" + "<BorderStyle><Default>Solid</Default></BorderStyle></Style>");
        ...
        for (Object __dummyForeachVar1 : this.lbTableColumns.Items)
        {
            String colname = (String)__dummyForeachVar1;
            ...
            if (this.rbVertComp.Checked)
            {
                ...
                table.AppendFormat("<TableRow><Height>12 pt</Height>" + "<Visibility><Hidden>=Iif({1} = Nothing, true, false)</Hidden></Visibility>" + "<TableCells><TableCell><ReportItems><Textbox>" + "{0}" + "<CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>None</Default></BorderStyle>" + "<Format>html</Format>" + "</Style></Textbox></ReportItems></TableCell>" + "</TableCells></TableRow>" + Environment.NewLine, val, dcol);
            }
            else
            {
                table.AppendFormat("<TableRow><Height>12 pt</Height><TableCells>" + "<TableCell><ReportItems><Textbox>" + "<Value>{0}</Value>" + "<Style><BorderStyle><Default>None</Default></BorderStyle>" + "<FontWeight>Bold</FontWeight>" + "<Color>Crimson</Color>" + "</Style></Textbox></ReportItems></TableCell>" + "</TableCells></TableRow>", colname);
                table.AppendFormat("<TableRow><Height>12 pt</Height><TableCells>" + "<TableCell><ReportItems><Textbox>" + "<Value>={0}</Value><CanGrow>true</CanGrow>" + "<Style><BorderStyle><Default>None</Default></BorderStyle>" + "</Style></Textbox></ReportItems></TableCell>" + "</TableCells></TableRow>", dcol);
            } 
        }
    ...
    */
    ...
    private void bRight_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        ar.Reverse();
        for (Object __dummyForeachVar3 : ar)
        {
    ...
    private void bLeft_Click(Object sender, System.EventArgs e) throws Exception {
        ICollection sic = lbTableColumns.SelectedIndices;
        int count = sic.Count;
        for (Object __dummyForeachVar4 : sic)
        {
            int i = (Integer)__dummyForeachVar4;
            String fname = (String)lbTableColumns.Items[i];
            lbFields.Items.Add(fname);
            if (StringSupport.equals(fname, this.cbGroupColumn.Text))
        ...
        {
            int i = (Integer)__dummyForeachVar5;
    ...
    private void bAllRight_Click(Object sender, System.EventArgs e) throws Exception {
        for (Object __dummyForeachVar6 : lbFields.Items)
        {
            Object fname = (Object)__dummyForeachVar6;
            lbTableColumns.Items.Add(fname);
        }
    ...
    private void bAllLeft_Click(Object sender, System.EventArgs e) throws Exception {
        for (Object __dummyForeachVar7 : lbTableColumns.Items)
        {
            Object fname = (Object)__dummyForeachVar7;
            lbFields.Items.Add(fname);
        }
    ...
    private void cbGroupColumn_Enter(Object sender, System.EventArgs e) throws Exception {
    ...
    private void rbHorz_CheckedChanged(Object sender, System.EventArgs e) throws Exception {
