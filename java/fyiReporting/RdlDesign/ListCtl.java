...
*/
public class ListCtl  extends System.Windows.Forms.UserControl implements IProperty
{
    private List<XmlNode> _ReportItems = new List<XmlNode>();
    private DesignXmlDraw _Draw;
    boolean fDataSet = new boolean(), fPBBefore = new boolean(), fPBAfter = new boolean(), fNoRows = new boolean(), fDataInstanceElementOutput = new boolean(), fDataInstanceName = new boolean();
    ...
    private System.Windows.Forms.Button bGroups = new System.Windows.Forms.Button();
    private System.Windows.Forms.Label label1 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox tbNoRows = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox tbDataInstanceName = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.CheckBox chkXmlInstances = new System.Windows.Forms.CheckBox();
    ...
    */
    ...
    public ListCtl(DesignXmlDraw dxDraw, List<XmlNode> ris) throws Exception {
        _ReportItems = ris;
        _Draw = dxDraw;
    ...
    private void initValues() throws Exception {
        ...
        this.chkXmlInstances.Checked = StringSupport.equals(_Draw.getElementValue(riNode,"DataInstanceElementOutput","Output"), "Output") ? true : false;
    ...
    */
    ...
    private void bGroups_Click(Object sender, System.EventArgs e) throws Exception {
    ...
    private void chkXmlInstances_CheckedChanged(Object sender, System.EventArgs e) throws Exception {
        fDataInstanceElementOutput = true;
    }

    private void tbDataInstanceName_TextChanged(Object sender, System.EventArgs e) throws Exception {
