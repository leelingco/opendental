...
*/
public class StyleBorderCtl  extends System.Windows.Forms.UserControl implements IProperty
{
    ...
    private boolean fStyleDefault = new boolean(), fStyleLeft = new boolean(), fStyleRight = new boolean(), fStyleTop = new boolean(), fStyleBottom = new boolean();
    private boolean fColorDefault = new boolean(), fColorLeft = new boolean(), fColorRight = new boolean(), fColorTop = new boolean(), fColorBottom = new boolean();
    private boolean fWidthDefault = new boolean(), fWidthLeft = new boolean(), fWidthRight = new boolean(), fWidthTop = new boolean(), fWidthBottom = new boolean();
    private System.Windows.Forms.Label label2 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label6 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label7 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbStyleLeft = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label label8 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbStyleBottom = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbStyleTop = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbStyleRight = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bColorLeft = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbColorLeft = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bColorRight = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbColorRight = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bColorTop = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbColorTop = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bColorBottom = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbColorBottom = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.TextBox tbWidthLeft = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox tbWidthRight = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox tbWidthTop = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox tbWidthBottom = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox tbWidthDefault = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Button bColorDefault = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbColorDefault = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbStyleDefault = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label lLeft = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label lBottom = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label lTop = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label lRight = new System.Windows.Forms.Label();
    private System.Windows.Forms.Button bSD = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bSL = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bSR = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bST = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bSB = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bCD = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bCT = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bCB = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWB = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWT = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWR = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bCR = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWL = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWD = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bCL = new System.Windows.Forms.Button();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    public StyleBorderCtl(DesignXmlDraw dxDraw, List<XmlNode> reportItems) throws Exception {
    ...
    private void initBorders(XmlNode node) throws Exception {
        ...
        if (StringSupport.equals(node.Name, "Line"))
        {
            cbColorLeft.Visible = cbColorRight.Visible = cbColorTop.Visible = cbColorBottom.Visible = bColorLeft.Visible = bColorRight.Visible = bColorTop.Visible = bColorBottom.Visible = cbStyleLeft.Visible = cbStyleRight.Visible = cbStyleTop.Visible = cbStyleBottom.Visible = lLeft.Visible = lRight.Visible = lTop.Visible = lBottom.Visible = tbWidthLeft.Visible = tbWidthRight.Visible = tbWidthTop.Visible = tbWidthBottom.Visible = bCR.Visible = bCL.Visible = bCT.Visible = bCB.Visible = bSR.Visible = bSL.Visible = bST.Visible = bSB.Visible = bWR.Visible = bWL.Visible = bWT.Visible = bWB.Visible = false;
        }
         
        fStyleDefault = fStyleLeft = fStyleRight = fStyleTop = fStyleBottom = fColorDefault = fColorLeft = fColorRight = fColorTop = fColorBottom = fWidthDefault = fWidthLeft = fWidthRight = fWidthTop = fWidthBottom = false;
    }
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        // cbStyleLeft
        //
        this.cbStyleLeft.Items.AddRange(new Object[]{ "None", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "WindowInset", "Outset" });
        ...
        // cbStyleBottom
        //
        this.cbStyleBottom.Items.AddRange(new Object[]{ "None", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "WindowInset", "Outset" });
        ...
        // cbStyleTop
        //
        this.cbStyleTop.Items.AddRange(new Object[]{ "None", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "WindowInset", "Outset" });
        ...
        // cbStyleRight
        //
        this.cbStyleRight.Items.AddRange(new Object[]{ "None", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "WindowInset", "Outset" });
        ...
        // cbStyleDefault
        //
        this.cbStyleDefault.Items.AddRange(new Object[]{ "None", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "WindowInset", "Outset" });
    ...
    private void applyChanges(XmlNode xNode) throws Exception {
        boolean bLine = StringSupport.equals(xNode.Name, "Line");
    ...
    private String getSize(String sz) throws Exception {
        ...
        if (size <= 0)
        {
            size = DesignXmlDraw.getSize(sz + "pt");
            // Try assuming pt
            if (size <= 0)
                // still no good
                size = 10;
    ...
    private void cbStyleDefault_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
        cbStyleLeft.Text = cbStyleRight.Text = cbStyleTop.Text = cbStyleBottom.Text = cbStyleDefault.Text;
        fStyleDefault = fStyleLeft = fStyleRight = fStyleTop = fStyleBottom = true;
    }

    private void cbColorDefault_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
        cbColorLeft.Text = cbColorRight.Text = cbColorTop.Text = cbColorBottom.Text = cbColorDefault.Text;
        fColorDefault = fColorLeft = fColorRight = fColorTop = fColorBottom = true;
    }

    private void tbWidthDefault_TextChanged(Object sender, System.EventArgs e) throws Exception {
        tbWidthLeft.Text = tbWidthRight.Text = tbWidthTop.Text = tbWidthBottom.Text = tbWidthDefault.Text;
        fWidthDefault = fWidthLeft = fWidthRight = fWidthTop = fWidthBottom = true;
    }

    private void cbStyle_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void cbColor_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void tbWidth_Changed(Object sender, System.EventArgs e) throws Exception {
    ...
    private void bExpr_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (__dummyScrutVar0.equals("sd"))
        {
            c = cbStyleDefault;
        }
        else if (__dummyScrutVar0.equals("cd"))
        {
            c = cbColorDefault;
            bColor = true;
        }
        else if (__dummyScrutVar0.equals("wd"))
        {
            c = tbWidthDefault;
        }
        else if (__dummyScrutVar0.equals("sl"))
        {
            c = cbStyleLeft;
        }
        ...
        else if (__dummyScrutVar0.equals("wl"))
        {
            c = tbWidthLeft;
        }
        else if (__dummyScrutVar0.equals("sr"))
        {
            c = cbStyleRight;
        }
        else if (__dummyScrutVar0.equals("cr"))
        {
            c = cbColorRight;
            bColor = true;
        }
        else if (__dummyScrutVar0.equals("wr"))
        {
            c = tbWidthRight;
        }
        ...
        else if (__dummyScrutVar0.equals("ct"))
        {
            c = cbColorTop;
            bColor = true;
        }
        else if (__dummyScrutVar0.equals("wt"))
        {
            c = tbWidthTop;
        }
        else if (__dummyScrutVar0.equals("sb"))
        {
            c = cbStyleBottom;
        }
        else if (__dummyScrutVar0.equals("cb"))
        {
            c = cbColorBottom;
            bColor = true;
        }
        else if (__dummyScrutVar0.equals("wb"))
        {
            c = tbWidthBottom;
        }
