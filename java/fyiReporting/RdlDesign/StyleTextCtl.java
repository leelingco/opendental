...
*/
public class StyleTextCtl  extends System.Windows.Forms.UserControl implements IProperty
{
    private List<XmlNode> _ReportItems = new List<XmlNode>();
    private DesignXmlDraw _Draw;
    private String _DataSetName = new String();
    private boolean fHorzAlign = new boolean(), fFormat = new boolean(), fDirection = new boolean(), fWritingMode = new boolean(), fTextDecoration = new boolean();
    private boolean fColor = new boolean(), fVerticalAlign = new boolean(), fFontStyle = new boolean(), fFontWeight = new boolean(), fFontSize = new boolean(), fFontFamily = new boolean();
    private boolean fValue = new boolean();
    ...
    private System.Windows.Forms.Label lFont = new System.Windows.Forms.Label();
    private System.Windows.Forms.Button bFont = new System.Windows.Forms.Button();
    private System.Windows.Forms.ComboBox cbHorzAlign = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbFormat = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbDirection = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbWritingMode = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label label2 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbTextDecoration = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bColor = new System.Windows.Forms.Button();
    private System.Windows.Forms.Label label9 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbColor = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbVerticalAlign = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label label3 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbFontStyle = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox cbFontWeight = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label label10 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbFontSize = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Label label11 = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbFontFamily = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.GroupBox groupBox1 = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.Label lblValue = new System.Windows.Forms.Label();
    private System.Windows.Forms.ComboBox cbValue = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.Button bValueExpr = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bFamily = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bStyle = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bColorEx = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bSize = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWeight = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button button2 = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bAlignment = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bDirection = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bVertical = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bWrtMode = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button bFormat = new System.Windows.Forms.Button();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    public StyleTextCtl(DesignXmlDraw dxDraw, List<XmlNode> styles) throws Exception {
        _ReportItems = styles;
        _Draw = dxDraw;
    ...
    private void initTextStyles() throws Exception {
        ...
        else if (StringSupport.equals(sNode.Name, "Textbox"))
        {
            ...
            for (XmlNode pNode = sNode.ParentNode;pNode != null;pNode = pNode.ParentNode)
            {
                ...
                if (StringSupport.equals(pNode.Name, "List") || StringSupport.equals(pNode.Name, "Table") || StringSupport.equals(pNode.Name, "Matrix") || StringSupport.equals(pNode.Name, "Chart"))
                {
        ...
        else if (StringSupport.equals(sNode.Name, "Title"))
        {
            lblValue.Text = "Caption";
            // Note: label needs to equal the element name
        ...
        for (Object __dummyForeachVar0 : sNode)
        {
            XmlNode lNode = (XmlNode)__dummyForeachVar0;
            if (lNode.NodeType != XmlNodeType.Element)
                continue;
             
            Name __dummyScrutVar0 = lNode.Name;
            if (__dummyScrutVar0.equals("FontStyle"))
            {
        ...
        for (Object __dummyForeachVar1 : FontFamily.Families)
        {
            // Population Font Family dropdown
            FontFamily ff = (FontFamily)__dummyForeachVar1;
        ...
        fHorzAlign = fFormat = fDirection = fWritingMode = fTextDecoration = fColor = fVerticalAlign = fFontStyle = fFontWeight = fFontSize = fFontFamily = fValue = false;
        return ;
    }
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        this.cbVerticalAlign.Items.AddRange(new Object[]{ "Top", "Middle", "Bottom" });
        ...
        this.cbHorzAlign.Items.AddRange(new Object[]{ "Left", "Center", "Right", "General" });
        ...
        // cbFormat
        //
        this.cbFormat.Items.AddRange(new Object[]{ "None", "", "#,##0", "#,##0.00", "0", "0.00", "", "MM/dd/yyyy", "dddd, MMMM dd, yyyy", "dddd, MMMM dd, yyyy HH:mm", "dddd, MMMM dd, yyyy HH:mm:ss", "MM/dd/yyyy HH:mm", "MM/dd/yyyy HH:mm:ss", "MMMM dd", "Ddd, dd MMM yyyy HH\':\'mm\'\"ss \'GMT\'", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss GMT", "HH:mm", "HH:mm:ss", "yyyy-MM-dd HH:mm:ss" });
        ...
        this.cbDirection.Items.AddRange(new Object[]{ "LTR", "RTL" });
        ...
        this.cbWritingMode.Items.AddRange(new Object[]{ "lr-tb", "tb-rl" });
        ...
        // cbTextDecoration
        //
        this.cbTextDecoration.Items.AddRange(new Object[]{ "None", "Underline", "Overline", "LineThrough" });
        ...
        // cbFontStyle
        //
        this.cbFontStyle.Items.AddRange(new Object[]{ "Normal", "Italic" });
        ...
        // cbFontWeight
        //
        this.cbFontWeight.Items.AddRange(new Object[]{ "Lighter", "Normal", "Bold", "Bolder", "100", "200", "300", "400", "500", "600", "700", "800", "900" });
        ...
        // cbFontSize
        //
        this.cbFontSize.Items.AddRange(new Object[]{ "8pt", "9pt", "10pt", "11pt", "12pt", "14pt", "16pt", "18pt", "20pt", "22pt", "24pt", "26pt", "28pt", "36pt", "48pt", "72pt" });
        ...
        // cbFontFamily
        //
        this.cbFontFamily.Items.AddRange(new Object[]{ "Arial" });
    ...
    public void applyChanges(XmlNode node) throws Exception {
        ...
        {
            if (fValue)
                _Draw.SetElement(node, lblValue.Text, cbValue.Text);
             
        }
         
        // only adjust value when single item selected
        ...
        if (fFontSize)
        {
            ...
            if (size <= 0)
            {
                size = DesignXmlDraw.GetSize(cbFontSize.Text + "pt");
                // Try assuming pt
                if (size <= 0)
                    // still no good
                    size = 10;
            ...
            _Draw.setElement(sNode,"FontSize",rs);
        }
        ...
        if (fFormat)
        {
            if (cbFormat.Text.Length == 0)
                // Don't put out a format if no format value
    ...
    private void bFont_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (StringSupport.equals(cbFontStyle.Text, "Italic"))
            fs |= System.Drawing.FontStyle.Italic;
         
        if (StringSupport.equals(cbTextDecoration.Text, "Underline"))
            fs |= FontStyle.Underline;
        else if (StringSupport.equals(cbTextDecoration.Text, "LineThrough"))
            fs |= FontStyle.Strikeout;
          
        // WEIGHT
        Text __dummyScrutVar1 = cbFontWeight.Text;
        if (__dummyScrutVar1.equals("Bold") || __dummyScrutVar1.equals("Bolder") || __dummyScrutVar1.equals("500") || __dummyScrutVar1.equals("600") || __dummyScrutVar1.equals("700") || __dummyScrutVar1.equals("800") || __dummyScrutVar1.equals("900"))
        {
        ...
        // just set default value
        Font drawFont = new Font(cbFontFamily.Text, size, fs);
        // si.FontSize already in points
        fd.Font = drawFont;
        fd.Color = DesignerUtility.ColorFromHtml(cbColor.Text, System.Drawing.Color.Black);
    ...
    private void bColor_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        cd.Color = DesignerUtility.ColorFromHtml(cbColor.Text, System.Drawing.Color.Black);
    ...
    private void cbValue_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fValue = true;
    }

    private void cbFontFamily_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fFontFamily = true;
    }

    private void cbFontSize_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fFontSize = true;
    }

    private void cbFontStyle_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fFontStyle = true;
    }

    private void cbFontWeight_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fFontWeight = true;
    }

    private void cbColor_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fColor = true;
    }

    private void cbTextDecoration_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fTextDecoration = true;
    }

    private void cbHorzAlign_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fHorzAlign = true;
    }

    private void cbVerticalAlign_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fVerticalAlign = true;
    }

    private void cbDirection_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fDirection = true;
    }

    private void cbWritingMode_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fWritingMode = true;
    }

    private void cbFormat_TextChanged(Object sender, System.EventArgs e) throws Exception {
        fFormat = true;
    }
    ...
    private void bExpr_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        System.String __dummyScrutVar2 = b.Tag instanceof String ? (String)b.Tag : (String)null;
        if (__dummyScrutVar2.equals("value"))
        {
            c = cbValue;
        }
        else if (__dummyScrutVar2.equals("family"))
        {
            c = cbFontFamily;
        }
        else if (__dummyScrutVar2.equals("style"))
        {
            c = cbFontStyle;
        }
        ...
        else if (__dummyScrutVar2.equals("size"))
        {
            c = cbFontSize;
        }
        ...
        else if (__dummyScrutVar2.equals("decoration"))
        {
            c = cbTextDecoration;
        }
        else if (__dummyScrutVar2.equals("halign"))
        {
            c = cbHorzAlign;
        }
        else if (__dummyScrutVar2.equals("valign"))
        {
            c = cbVerticalAlign;
        }
        else if (__dummyScrutVar2.equals("direction"))
        {
            c = cbDirection;
        }
        else if (__dummyScrutVar2.equals("writing"))
        {
            c = cbWritingMode;
        }
        else if (__dummyScrutVar2.equals("format"))
        {
            c = cbFormat;
        }
