...
*/
public class DialogExprEditor  extends System.Windows.Forms.Form 
{
    Type[] BASE_TYPES = new Type[]{ System.String.Empty.GetType(), System.Double.MinValue.GetType(), System.Single.MinValue.GetType(), System.Decimal.MinValue.GetType(), System.DateTime.MinValue.GetType(), System.Char.MinValue.GetType(), (new boolean()).GetType(), System.Int32.MinValue.GetType(), System.Int16.MinValue.GetType(), System.Int64.MinValue.GetType(), System.Byte.MinValue.GetType(), System.UInt16.MinValue.GetType(), System.UInt32.MinValue.GetType(), System.UInt64.MinValue.GetType() };
    private DesignXmlDraw _Draw;
    // design draw
    private boolean _Color = new boolean();
    // true if color list should be displayed
    ...
    private System.Windows.Forms.TextBox tbExpr = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Button bCopy = new System.Windows.Forms.Button();
    private System.Windows.Forms.TreeView tvOp = new System.Windows.Forms.TreeView();
    private System.Windows.Forms.Label lExpr = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label lOp = new System.Windows.Forms.Label();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    public DialogExprEditor(DesignXmlDraw dxDraw, String expr, XmlNode node) throws Exception {
        this(dxDraw, expr, node, false);
    }

    public DialogExprEditor(DesignXmlDraw dxDraw, String expr, XmlNode node, boolean bColor) throws Exception {
        _Draw = dxDraw;
        _Color = bColor;
        //
    ...
    void buildTree(String[] flds) throws Exception {
        // suppress redraw until tree view is complete
        tvOp.BeginUpdate();
        // Handle the globals
        TreeNode ndRoot = new TreeNode("Globals");
        tvOp.Nodes.Add(ndRoot);
        for (Object __dummyForeachVar0 : StaticLists.GlobalList)
        {
            String item = (String)__dummyForeachVar0;
        ...
        tvOp.Nodes.Add(ndRoot);
        for (Object __dummyForeachVar2 : StaticLists.AggrFunctionList)
        {
            String item = (String)__dummyForeachVar2;
            // Add the node to the tree
        ...
        tvOp.Nodes.Add(ndRoot);
        for (Object __dummyForeachVar3 : StaticLists.OperatorList)
        {
        ...
        if (_Color)
        {
            ...
            tvOp.Nodes.Add(ndRoot);
            for (Object __dummyForeachVar4 : StaticLists.ColorList)
            {
    ...
    */
    void initReportParameters() throws Exception {
        ...
        tvOp.Nodes.Add(ndRoot);
        for (Object __dummyForeachVar5 : ps)
        {
            String p = (String)__dummyForeachVar5;
    ...
    void initFunctions(TreeNode ndRoot) throws Exception {
        List<String> ar = new List<String>();
        ar.AddRange(StaticLists.FunctionList);
        // Build list of methods in the  VBFunctions class
        fyiReporting.RDL.FontStyleEnum fsi = fyiReporting.RDL.FontStyleEnum.Italic;
        // just want a class from RdlEngine.dll assembly
        ...
        ar.Sort();
        String previous = "";
        for (Object __dummyForeachVar6 : ar)
        {
            String item = (String)__dummyForeachVar6;
            if (!StringSupport.equals(item, previous))
            {
    ...
    void buildMethods(List<String> ar, Type ft, String prefix) throws Exception {
        if (ft == null)
            return ;
         
        MethodInfo[] mis = ft.GetMethods(BindingFlags.Static | BindingFlags.Public);
        for (Object __dummyForeachVar7 : mis)
        {
            MethodInfo mi = (MethodInfo)__dummyForeachVar7;
            // Add the node to the tree
    ...
    String buildMethodName(MethodInfo mi) throws Exception {
        StringBuilder sb = new StringBuilder(mi.Name);
        sb.Append("(");
        ParameterInfo[] pis = mi.GetParameters();
        boolean bFirst = true;
        for (Object __dummyForeachVar8 : pis)
        {
            ParameterInfo pi = (ParameterInfo)__dummyForeachVar8;
    ...
    boolean isBaseType(Type t) throws Exception {
        for (Object __dummyForeachVar9 : BASE_TYPES)
        {
            Type bt = (Type)__dummyForeachVar9;
            if (bt == t)
                return true;
    ...
    */
    ...
    private void bCopy_Click(Object sender, System.EventArgs e) throws Exception {
        if (tvOp.SelectedNode == null || tvOp.SelectedNode.Parent == null)
            return ;
         
        // this is the top level nodes (Fields, Parameters, ...)
        TreeNode node = tvOp.SelectedNode;
        String t = node.Text;
        tbExpr.SelectedText = t;
    }

    private void dialogExprEditor_Layout(Object sender, System.Windows.Forms.LayoutEventArgs e) throws Exception {
