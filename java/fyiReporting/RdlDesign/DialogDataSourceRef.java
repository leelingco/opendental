...
*/
public class DialogDataSourceRef  extends System.Windows.Forms.Form 
{
    private System.Windows.Forms.Label label1 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox tbPassword = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox tbPassword2 = new System.Windows.Forms.TextBox();
    ...
    */
    ...
    public DialogDataSourceRef() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        this.label1.Text = "Enter (twice) a pass phrase used to encrypt the data source reference file.   You" + " should use the same password you\'ve used to create previous files, as only one " + "can be used.";
        //
        // tbPassword
        //
    ...
    private void bGetFilename_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        sfd.Filter = "Data source reference files (*.dsr)|*.dsr" + "All files (*.*)|*.*|";
        sfd.FilterIndex = 1;
    ...
    private void validate_TextChanged(Object sender, System.EventArgs e) throws Exception {
        if (this.tbFilename.Text.Length > 0 && this.tbPassword.Text.Length > 0 && this.tbPassword.Text == this.tbPassword2.Text && this.tbConnection.Text.Length > 0)
            bOK.Enabled = true;
        else
            bOK.Enabled = false; 
        return ;
    ...
    private void bOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        sb.AppendFormat("<DataProvider>{0}</DataProvider>", this.cbDataProvider.Text);
        sb.AppendFormat("<ConnectString>{0}</ConnectString>", this.tbConnection.Text.Replace("<", "&lt;"));
        sb.AppendFormat("<IntegratedSecurity>{0}</IntegratedSecurity>", this.ckbIntSecurity.Checked ? "true" : "false");
        if (this.tbPrompt.Text.Length > 0)
            sb.AppendFormat("<Prompt>{0}</Prompt>", this.tbPrompt.Text.Replace("<", "&lt;"));
    ...
    private void cbDataProvider_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
        if (StringSupport.equals(cbDataProvider.Text, "ODBC"))
        {
