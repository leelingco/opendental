...
{
    public static long PatNum1 = new long();
    public static long PatNum2 = new long();
    public static long PatNum3 = new long();
    public static long PatNum4 = new long();
    public static long PatNum5 = new long();
    public static long PatNum6 = new long();
    public static long PatNum7 = new long();
    public static long PatNum8 = new long();
    public static long PatNum9 = new long();
    public static String setInitialPatients() throws Exception {
        Patient pat;
        Patient oldPatient;
        InsPlan plan;
        InsSub sub;
        ...
        pat.Zip = "M7F2J9";
        pat.Language = "en";
        pat.Guarantor = PatNum2;
        //same family as patient #1.
        Patients.insert(pat,false);
        PatNum3 = pat.PatNum;
        //primary coverage------------------------------
        patplan = new PatPlan();
        ...
        //had to add this as separate plan because of unique subscriber id.
        InsSubs.insert(sub);
        patplan = new PatPlan();
        patplan.PatNum = pat.PatNum;
        patplan.InsSubNum = sub.InsSubNum;
        ...
        sub.PlanNum = plan.PlanNum;
        sub.Subscriber = pat.PatNum;
        sub.SubscriberID = "30322145";
        //concat bandNumber(303) and familyNumber(22145)
        InsSubs.insert(sub);
        patplan = new PatPlan();
        patplan.PatNum = pat.PatNum;
        patplan.InsSubNum = sub.InsSubNum;
