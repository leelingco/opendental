...
public class EduResourceCrud   
{
    ...
    */
    public static void update(EduResource eduResource, EduResource oldEduResource) throws Exception {
        ...
        if (!StringSupport.equals(eduResource.LabResultID, oldEduResource.LabResultID))
        {
            if (!StringSupport.equals(command, ""))
            {
                command += ",";
        ...
        if (!StringSupport.equals(eduResource.LabResultName, oldEduResource.LabResultName))
        {
            if (!StringSupport.equals(command, ""))
            {
                command += ",";
        ...
        if (!StringSupport.equals(eduResource.LabResultCompare, oldEduResource.LabResultCompare))
        {
            if (!StringSupport.equals(command, ""))
            {
                command += ",";
        ...
        if (!StringSupport.equals(eduResource.ResourceUrl, oldEduResource.ResourceUrl))
        {
            if (!StringSupport.equals(command, ""))
            {
                command += ",";
