...
public class LetterCrud   
{
    ...
    */
    public static long insert(Letter letter, boolean useExistingPK) throws Exception {
        ...
        command += "'" + POut.String(letter.Description) + "'," + DbHelper.ParamChar + "paramBodyText)";
    ...
    */
    public static void update(Letter letter) throws Exception {
        String command = "UPDATE letter SET " + "Description= '" + POut.String(letter.Description) + "', " + "BodyText   =  " + DbHelper.ParamChar + "paramBodyText " + "WHERE LetterNum = " + POut.Long(letter.LetterNum);
        if (letter.BodyText == null)
        {
            letter.BodyText = "";
        }
