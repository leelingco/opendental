...
public class ErxLogCrud   
{
    ...
    */
    public static long insert(ErxLog erxLog, boolean useExistingPK) throws Exception {
        ...
        command += POut.Long(erxLog.PatNum) + "," + DbHelper.ParamChar + "paramMsgText," + POut.Long(erxLog.ProvNum) + ")";
    ...
    */
    public static void update(ErxLog erxLog) throws Exception {
        //DateTStamp can only be set by MySQL
        String command = "UPDATE erxlog SET " + "PatNum    =  " + POut.Long(erxLog.PatNum) + ", " + "MsgText   =  " + DbHelper.ParamChar + "paramMsgText, " + "ProvNum   =  " + POut.Long(erxLog.ProvNum) + " " + "WHERE ErxLogNum = " + POut.Long(erxLog.ErxLogNum);
        if (erxLog.MsgText == null)
        {
            erxLog.MsgText = "";
        }
