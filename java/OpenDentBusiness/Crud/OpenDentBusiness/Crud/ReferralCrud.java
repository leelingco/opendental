...
{
    /**
    * Gets one Referral object from the database using the primary key.  Returns null if not found.
    */
    public static Referral selectOne(long referralNum) throws Exception {
    ...
    /**
    * Gets one Referral object from the database using a query.
    */
    public static Referral selectOne(String command) throws Exception {
    ...
    /**
    * Gets a list of Referral objects from the database using a query.
    */
    public static List<Referral> selectMany(String command) throws Exception {
        if (RemotingClient.RemotingRole == RemotingRole.ClientWeb)
        {
            throw new ApplicationException("Not allowed to send sql directly.  Rewrite the calling class to not use this query:\r\n" + command);
        }
    ...
    */
    public static List<Referral> tableToList(DataTable table) throws Exception {
    ...
    /**
    * Inserts one Referral into the database.  Returns the new priKey.
    */
    public static long insert(Referral referral) throws Exception {
    ...
    /**
    * Inserts one Referral into the database.  Provides option to use the existing priKey.
    */
    public static long insert(Referral referral, boolean useExistingPK) throws Exception {
        ...
        command += "'" + POut.String(referral.LName) + "'," + "'" + POut.String(referral.FName) + "'," + "'" + POut.String(referral.MName) + "'," + "'" + POut.String(referral.SSN) + "'," + POut.Bool(referral.UsingTIN) + "," + POut.Int((int)referral.Specialty) + "," + "'" + POut.String(referral.ST) + "'," + "'" + POut.String(referral.Telephone) + "'," + "'" + POut.String(referral.Address) + "'," + "'" + POut.String(referral.Address2) + "'," + "'" + POut.String(referral.City) + "'," + "'" + POut.String(referral.Zip) + "'," + "'" + POut.String(referral.Note) + "'," + "'" + POut.String(referral.Phone2) + "'," + POut.Bool(referral.IsHidden) + "," + POut.Bool(referral.NotPerson) + "," + "'" + POut.String(referral.Title) + "'," + "'" + POut.String(referral.EMail) + "'," + POut.Long(referral.PatNum) + "," + "'" + POut.String(referral.NationalProvID) + "'," + POut.Long(referral.Slip) + "," + POut.Bool(referral.IsDoctor) + ")";
        if (useExistingPK || PrefC.RandomKeys)
        {
            Db.NonQ(command);
        }
    ...
    /**
    * Updates one Referral in the database.
    */
    public static void update(Referral referral) throws Exception {
        String command = "UPDATE referral SET " + "LName         = '" + POut.String(referral.LName) + "', " + "FName         = '" + POut.String(referral.FName) + "', " + "MName         = '" + POut.String(referral.MName) + "', " + "SSN           = '" + POut.String(referral.SSN) + "', " + "UsingTIN      =  " + POut.Bool(referral.UsingTIN) + ", " + "Specialty     =  " + POut.Int((int)referral.Specialty) + ", " + "ST            = '" + POut.String(referral.ST) + "', " + "Telephone     = '" + POut.String(referral.Telephone) + "', " + "Address       = '" + POut.String(referral.Address) + "', " + "Address2      = '" + POut.String(referral.Address2) + "', " + "City          = '" + POut.String(referral.City) + "', " + "Zip           = '" + POut.String(referral.Zip) + "', " + "Note          = '" + POut.String(referral.Note) + "', " + "Phone2        = '" + POut.String(referral.Phone2) + "', " + "IsHidden      =  " + POut.Bool(referral.IsHidden) + ", " + "NotPerson     =  " + POut.Bool(referral.NotPerson) + ", " + "Title         = '" + POut.String(referral.Title) + "', " + "EMail         = '" + POut.String(referral.EMail) + "', " + "PatNum        =  " + POut.Long(referral.PatNum) + ", " + "NationalProvID= '" + POut.String(referral.NationalProvID) + "', " + "Slip          =  " + POut.Long(referral.Slip) + ", " + "IsDoctor      =  " + POut.Bool(referral.IsDoctor) + " " + "WHERE ReferralNum = " + POut.Long(referral.ReferralNum);
        Db.NonQ(command);
    }

    /**
    * Updates one Referral in the database.  Uses an old object to compare to, and only alters changed fields.  This prevents collisions and concurrency problems in heavily used tables.
    */
    public static void update(Referral referral, Referral oldReferral) throws Exception {
        String command = "";
        ...
        command = "UPDATE referral SET " + command + " WHERE ReferralNum = " + POut.Long(referral.ReferralNum);
        Db.NonQ(command);
    }

    /**
    * Deletes one Referral from the database.
    */
    public static void delete(long referralNum) throws Exception {
        String command = "DELETE FROM referral " + "WHERE ReferralNum = " + POut.Long(referralNum);
        Db.NonQ(command);
    }
