...
public class HL7DefSegmentCrud   
{
    ...
    */
    public static List<HL7DefSegment> tableToList(DataTable table) throws Exception {
        ...
        for (int i = 0;i < table.Rows.Count;i++)
        {
            ...
            {
                hL7DefSegment.SegmentName = SegmentNameHL7.values()[0];
            }
            else
                try
                {
    ...
    */
    public static long insert(HL7DefSegment hL7DefSegment, boolean useExistingPK) throws Exception {
        ...
        command += POut.long(hL7DefSegment.HL7DefMessageNum) + "," + POut.int(hL7DefSegment.ItemOrder) + "," + POut.bool(hL7DefSegment.CanRepeat) + "," + POut.bool(hL7DefSegment.IsOptional) + "," + "'" + POut.String(hL7DefSegment.SegmentName.ToString()) + "'," + DbHelper.getParamChar() + "paramNote)";
    ...
    */
    public static void update(HL7DefSegment hL7DefSegment) throws Exception {
        String command = "UPDATE hl7defsegment SET " + "HL7DefMessageNum=  " + POut.long(hL7DefSegment.HL7DefMessageNum) + ", " + "ItemOrder       =  " + POut.int(hL7DefSegment.ItemOrder) + ", " + "CanRepeat       =  " + POut.bool(hL7DefSegment.CanRepeat) + ", " + "IsOptional      =  " + POut.bool(hL7DefSegment.IsOptional) + ", " + "SegmentName     = '" + POut.String(hL7DefSegment.SegmentName.ToString()) + "', " + "Note            =  " + DbHelper.getParamChar() + "paramNote " + "WHERE HL7DefSegmentNum = " + POut.long(hL7DefSegment.HL7DefSegmentNum);
        if (hL7DefSegment.Note == null)
        {
            hL7DefSegment.Note = "";
        }
    ...
    */
    public static void update(HL7DefSegment hL7DefSegment, HL7DefSegment oldHL7DefSegment) throws Exception {
        ...
        if (!StringSupport.equals(hL7DefSegment.Note, oldHL7DefSegment.Note))
        {
            if (!StringSupport.equals(command, ""))
            {
                command += ",";
