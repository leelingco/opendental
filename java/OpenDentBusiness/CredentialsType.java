...
public class CredentialsType   
{
    ...
    private String productNameField = new String();
    private String productVersionField = new String();
    /**
    * 
    */
    ...
    */
    ...
    public void setproductName(String value) throws Exception {
    ...
    */
    ...
    public void setproductVersion(String value) throws Exception {
