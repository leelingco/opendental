...
package WebHostSynch.Properties;
...
public final class Settings  extends System.Configuration.ApplicationSettingsBase 
{
    ...
    public String getSheetDefAddress() throws Exception {
        return ((String)(this["SheetDefAddress"]));
    }

    public String getDBMobileWeb() throws Exception {
        return ((String)(this["DBMobileWeb"]));
    }

    public String getPatientPortalAddress() throws Exception {
