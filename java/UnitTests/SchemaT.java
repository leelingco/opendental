...
import OpenDentBusiness.SchemaCrudProposedTest;
...
public class SchemaT   
{
    ...
    public static String testProposedCrud(boolean isOracle) throws Exception {
        String retVal = "";
    ...
    public static String compareProposedToGenerated(boolean isOracle) throws Exception {
