...
* 
*/
public class FormAbout  extends System.Windows.Forms.Form 
{
    ...
    */
    public FormAbout() throws Exception {
        initializeComponent();
        Lan.F(this, new Control[]{ labelVersion, textBox1 });
    }
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        ...
        this.label1.Text = "Open Dental (AKA Free Dental)  Copyright 2003, Jordan S. Sparks, D.M.D., www.open" + "-dent.com  1-877-686-1248";
        //
        // label2
        //
        ...
        this.label4.Text = "All parts of this program are licensed under the GPL, www.opensource.org/licenses" + "/gpl-license.php";
        //
        // textBox1
        //
    ...
    private void formAbout_Load(Object sender, System.EventArgs e) throws Exception {
    ...
    private void butReset_Click(Object sender, System.EventArgs e) throws Exception {
