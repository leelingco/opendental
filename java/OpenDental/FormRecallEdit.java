//
// Translated by CS2J (http://www.cs2j.com): 2/15/2016 7:59:37 PM
//
...
*/
public class FormRecallEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.TextBox textDatePrevious = new System.Windows.Forms.TextBox();
    private OpenDental.ValidNum textMonths;
    private OpenDental.ValidNum textDays;
    private OpenDental.ValidNum textWeeks;
    private System.Windows.Forms.CheckBox checkIsDisabled = new System.Windows.Forms.CheckBox();
    private OpenDental.UI.Button butOK;
    private OpenDental.UI.Button butDelete;
    /**
    * The recall object to edit.
    */
    public Recall RecallCur;
    private System.Windows.Forms.TextBox textDateDueCalc = new System.Windows.Forms.TextBox();
    ...
    */
    ...
    private OpenDental.ValidDate textDisableDate;
    private Label label12 = new Label();
    private OpenDental.ValidDouble textBalance;
    private TextBox textScheduledDate = new TextBox();
    private Label label13 = new Label();
    private Label label10 = new Label();
    //private Patient PatCur;
    /**
    * Don't forget to set the RecallCur before opening this form.
    */
    public FormRecallEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormRecallEdit.class);
        ...
        this.textNote.setQuickPasteType(OpenDentBusiness.QuickPasteType.Recall);
    ...
    private void formRecallEdit_Load(Object sender, System.EventArgs e) throws Exception {
        for (int i = 0;i < RecallTypeC.getListt().Count;i++)
        {
            comboType.Items.Add(RecallTypeC.getListt()[i].Description);
            if (RecallCur.RecallTypeNum == RecallTypeC.getListt()[i].RecallTypeNum)
            {
        ...
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.RecallUnschedStatus).ordinal()].Length;i++)
        {
            ...
            if (DefC.getShort()[((Enum)DefCat.RecallUnschedStatus).ordinal()][i].DefNum == RecallCur.RecallStatus)
    ...
    private void comboType_SelectionChangeCommitted(Object sender, EventArgs e) throws Exception {
        //not possible unless new recall manually being entered
        Interval iv = RecallTypeC.getListt()[comboType.SelectedIndex].DefaultInterval;
        ...
        List<RecallTrigger> triggerList = RecallTriggers.GetForType(RecallTypeC.getListt()[comboType.SelectedIndex].RecallTypeNum);
        if (triggerList.Count == 0)
        {
            //if no triggers, then it's a manual type
            RecallCur.DatePrevious = DateTimeOD.getToday();
    ...
    private void checkIsDisabled_Click(Object sender, System.EventArgs e) throws Exception {
        if (checkIsDisabled.Checked)
        {
            textDateDue.Text = "";
            textDateDue.ReadOnly = true;
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (!StringSupport.equals(textDateDue.errorProvider1.GetError(textDateDue), "") || !StringSupport.equals(textYears.errorProvider1.GetError(textYears), "") || !StringSupport.equals(textMonths.errorProvider1.GetError(textMonths), "") || !StringSupport.equals(textWeeks.errorProvider1.GetError(textWeeks), "") || !StringSupport.equals(textDays.errorProvider1.GetError(textDays), "") || !StringSupport.equals(textBalance.errorProvider1.GetError(textBalance), "") || !StringSupport.equals(textDisableDate.errorProvider1.GetError(textDisableDate), ""))
        {
        ...
        RecallCur.RecallTypeNum = RecallTypeC.getListt()[comboType.SelectedIndex].RecallTypeNum;
        ...
        {
            RecallCur.RecallStatus = DefC.getShort()[((Enum)DefCat.RecallUnschedStatus).ordinal()][comboStatus.SelectedIndex - 1].DefNum;
        } 
