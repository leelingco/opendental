...
* 
*/
public class FormPrintPreview  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    long PatNumCur = new long();
    String AuditDescription = new String();
    /**
    * Must supply the printSituation so that when user clicks print, we know where to send it.  Must supply total pages.  PatNum and AuditDescription used to make audit log entry.  PatNum can be 0.  Audit Log Text will show AuditDescription exactly.
    */
    public FormPrintPreview(PrintSituation sit, PrintDocument document, int totalPages, long patNum, String auditDescription) throws Exception {
        initializeComponent();
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(OpenDental.UI.FormPrintPreview.class);
