...
public class DateTimeOD   
{
    ...
    */
    ...
    public static DateTime getToday() throws Exception {
        return new DateTime(DateTime.Today.Year, DateTime.Today.Month, DateTime.Today.Day, 0, 0, 0, DateTimeKind.Unspecified);
    }

}


//Today at midnight with no timezone information.