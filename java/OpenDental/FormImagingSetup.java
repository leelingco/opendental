...
import OpenDental.UI.ContrWindowingSlider;
...
* 
*/
public class FormImagingSetup  extends System.Windows.Forms.Form 
{
    ...
    private NumericUpDown upDownExposure = new NumericUpDown();
    private NumericUpDown upDownPort = new NumericUpDown();
    private Label label4 = new Label();
    private Label label3 = new Label();
    private OpenDental.ValidNum textScanDocQuality;
    private ComboBox comboType = new ComboBox();
    private OpenDental.ValidNum textScanDocResolution;
    private Label label6 = new Label();
    private Label label5 = new Label();
    private OpenDental.UI.Button butSetScanner;
    private CheckBox checkScanDocSelectSource = new CheckBox();
    private CheckBox checkScanDocDuplex = new CheckBox();
    private Label label7 = new Label();
    private CheckBox checkScanDocGrayscale = new CheckBox();
    private RadioButton radioScanDocUseOptionsBelow = new RadioButton();
    private RadioButton radioScanDocShowOptions = new RadioButton();
    private GroupBox groupScanningOptions = new GroupBox();
    private Label label8 = new Label();
    private CheckBox checkBinned = new CheckBox();
    //private ComputerPref computerPrefs;
    /**
    * 
    */
    public FormImagingSetup() throws Exception {
        initializeComponent();
        //too many labels to use Lan.F()
        Lan.C(this, new System.Windows.Forms.Control[]{ this, this.groupBox1, this.groupBox2, this.groupBox3, this.label1, this.label2, this.label3, this.label4, this.label5, this.label6, this.label7, this.label12, this.label25, this.label37 });
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormImagingSetup.class);
        ...
        this.textScanDocResolution.setMaxVal(1000);
        this.textScanDocResolution.setMinVal(51);
        ...
        this.textScanDocQuality.setMaxVal(100);
        this.textScanDocQuality.setMinVal(0);
        ...
        this.upDownPort.Maximum = new double(new int[]{ 1, 0, 0, 0 });
        ...
        this.upDownExposure.Maximum = new double(new int[]{ 7, 0, 0, 0 });
        this.upDownExposure.Minimum = new double(new int[]{ 1, 0, 0, 0 });
        ...
        this.upDownExposure.Value = new double(new int[]{ 1, 0, 0, 0 });
        //
        // butSetScanner
        //
        this.butSetScanner.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butSetScanner.setAutosize(true);
        this.butSetScanner.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butSetScanner.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butSetScanner.setCornerRadius(4F);
        ...
        // butMounts
        //
        this.butMounts.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        ...
        this.butMounts.setAutosize(true);
        this.butMounts.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butMounts.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butMounts.setCornerRadius(4F);
        ...
        this.label8.Text = "If this setting causes your scanner to malfunction, use the \"Show Scanner Options" + " Window\" instead";
    ...
    private void formImagingSetup_Load(Object sender, System.EventArgs e) throws Exception {
        comboType.Items.Add("B");
        comboType.Items.Add("D");
        checkScanDocSelectSource.Checked = ComputerPrefs.getLocalComputer().ScanDocSelectSource;
        if (ComputerPrefs.getLocalComputer().ScanDocShowOptions)
        {
        ...
        checkScanDocDuplex.Checked = ComputerPrefs.getLocalComputer().ScanDocDuplex;
        checkScanDocGrayscale.Checked = ComputerPrefs.getLocalComputer().ScanDocGrayscale;
        textScanDocResolution.Text = ComputerPrefs.getLocalComputer().ScanDocResolution.ToString();
        textScanDocQuality.Text = ComputerPrefs.getLocalComputer().ScanDocQuality.ToString();
        //textScanDocQuality.Text=PrefC.GetLong(PrefName.ScannerCompression).ToString();
        slider.setMinVal(PrefC.getInt(PrefName.ImageWindowingMin));
        slider.setMaxVal(PrefC.getInt(PrefName.ImageWindowingMax));
        upDownPort.Value = ComputerPrefs.getLocalComputer().SensorPort;
        comboType.Text = ComputerPrefs.getLocalComputer().SensorType;
        checkBinned.Checked = ComputerPrefs.getLocalComputer().SensorBinned;
        int exposureLevelVal = ComputerPrefs.getLocalComputer().SensorExposure;
        if (exposureLevelVal < (int)upDownExposure.Minimum || exposureLevelVal > (int)upDownExposure.Maximum)
        {
            exposureLevelVal = (int)upDownExposure.Minimum;
        }
         
        //Play it safe with the default exposure.
    ...
    private void radioScanDocShowOptions_CheckedChanged(Object sender, EventArgs e) throws Exception {
    ...
    private void butMounts_Click(Object sender, EventArgs e) throws Exception {
        FormMountDefs FormM = new FormMountDefs();
        FormM.ShowDialog();
    }

    private void butSetScanner_Click(Object sender, EventArgs e) throws Exception {
        xImageDeviceManager.Obfuscator.ActivateEZTwain();
        EZTwain.SelectImageSource(this.Handle);
    }

    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textScanDocQuality.errorProvider1.GetError(textScanDocQuality), "") || !StringSupport.equals(textScanDocResolution.errorProvider1.GetError(textScanDocResolution), ""))
        {
            MessageBox.Show(Lan.g(this,"Please fix data entry errors first."));
            return ;
        }
         
        ComputerPrefs.getLocalComputer().ScanDocSelectSource = checkScanDocSelectSource.Checked;
        ComputerPrefs.getLocalComputer().ScanDocShowOptions = radioScanDocShowOptions.Checked;
        ComputerPrefs.getLocalComputer().ScanDocDuplex = checkScanDocDuplex.Checked;
        ComputerPrefs.getLocalComputer().ScanDocGrayscale = checkScanDocGrayscale.Checked;
        ComputerPrefs.getLocalComputer().ScanDocResolution = PIn.Int(textScanDocResolution.Text);
        ComputerPrefs.getLocalComputer().ScanDocQuality = PIn.Byte(textScanDocQuality.Text);
        //Prefs.UpdateLong(PrefName.ScannerCompression,PIn.Long(textScanDocQuality.Text));
        Prefs.UpdateLong(PrefName.ImageWindowingMin, slider.getMinVal());
        Prefs.UpdateLong(PrefName.ImageWindowingMax, slider.getMaxVal());
        ...
        ComputerPrefs.getLocalComputer().SensorType = comboType.Text;
        ComputerPrefs.getLocalComputer().SensorPort = (int)upDownPort.Value;
        ComputerPrefs.getLocalComputer().SensorExposure = (int)upDownExposure.Value;
        ComputerPrefs.getLocalComputer().SensorBinned = checkBinned.Checked;
