...
public interface SynchAllergyDefsCompletedEventHandler   
{
    void invoke(Object sender, System.ComponentModel.AsyncCompletedEventArgs e) throws Exception ;

    System.Collections.Generic.IList<SynchAllergyDefsCompletedEventHandler> getInvocationList() throws Exception ;
