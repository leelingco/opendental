...
import OpenDental.FormDrugManufacturerEdit;
import OpenDental.Lan;
import OpenDentBusiness.DrugManufacturer;
import OpenDentBusiness.DrugManufacturers;
import OpenDental.Properties.Resources;

public class FormDrugManufacturerSetup  extends Form 
{

    public FormDrugManufacturerSetup() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formDrugManufacturerSetup_Load(Object sender, EventArgs e) throws Exception {
        fillGrid();
    }
    ...
    private void fillGrid() throws Exception {
        ...
        {
            listMain.Items.Add(DrugManufacturers.getListt()[i].ManufacturerCode + " - " + DrugManufacturers.getListt()[i].ManufacturerName);
        }
    }
    ...
    private void listMain_DoubleClick(Object sender, EventArgs e) throws Exception {
        ...
        FormD.DrugManufacturerCur = DrugManufacturers.getListt()[listMain.SelectedIndex];
        FormD.ShowDialog();
        fillGrid();
    }
