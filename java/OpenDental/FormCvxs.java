...
public class FormCvxs  extends Form 
{

    public boolean IsSelectionMode = new boolean();
    public Cvx SelectedCvx;
    private List<Cvx> listCvxs = new List<Cvx>();
    public FormCvxs() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formCvxs_Load(Object sender, EventArgs e) throws Exception {
        if (IsSelectionMode)
        {
    ...
    private void fillGrid() throws Exception {
        ...
        for (int i = 0;i < listCvxs.Count;i++)
        {
            ...
            row.getCells().Add(listCvxs[i].CvxCode);
            row.getCells().Add(listCvxs[i].Description);
            row.setTag(listCvxs[i]);
    ...
    private void gridMain_CellDoubleClick(Object sender, OpenDental.UI.ODGridClickEventArgs e) throws Exception {
        if (IsSelectionMode)
        {
            SelectedCvx = (Cvx)gridMain.getRows().get___idx(e.getRow()).getTag();
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        ...
        SelectedCvx = (Cvx)gridMain.getRows().get___idx(gridMain.getSelectedIndex()).getTag();
        DialogResult = DialogResult.OK;
    }
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormCvxs.class);
        ...
        this.gridMain.setTitle("CVX Codes");
        this.gridMain.setTranslationName("FormCvxCodes");
