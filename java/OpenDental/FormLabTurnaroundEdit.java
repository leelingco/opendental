...
*/
public class FormLabTurnaroundEdit  extends System.Windows.Forms.Form 
{
    ...
    private OpenDental.ValidNum textDaysActual;
    private Label label4 = new Label();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    private OpenDental.ValidNumber textDaysPublished;
    public LabTurnaround LabTurnaroundCur;
    /**
    * 
    */
    public FormLabTurnaroundEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormLabTurnaroundEdit.class);
        ...
        this.textDaysActual.setMaxVal(255);
        this.textDaysActual.setMinVal(0);
        ...
        this.textDaysPublished.setMaxVal(255);
        this.textDaysPublished.setMinVal(0);
    ...
    private void formLabTurnaroundEdit_Load(Object sender, EventArgs e) throws Exception {
        textDescription.Text = LabTurnaroundCur.Description;
        if (LabTurnaroundCur.DaysPublished > 0)
        {
            textDaysPublished.Text = LabTurnaroundCur.DaysPublished.ToString();
        }
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textDaysActual.errorProvider1.GetError(textDaysActual), "") || !StringSupport.equals(textDaysPublished.errorProvider1.GetError(textDaysPublished), ""))
        {
