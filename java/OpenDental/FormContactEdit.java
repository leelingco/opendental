...
*/
public class FormContactEdit  extends System.Windows.Forms.Form 
{
    ...
    * 
    */
    public FormContactEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormContactEdit.class);
    ...
    private void formContactEdit_Load(Object sender, System.EventArgs e) throws Exception {
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.ContactCategories).ordinal()].Length;i++)
        {
            ...
            if (ContactCur.Category == DefC.getShort()[((Enum)DefCat.ContactCategories).ordinal()][i].DefNum)
            {
    ...
    private void textFax_TextChanged(Object sender, System.EventArgs e) throws Exception {
