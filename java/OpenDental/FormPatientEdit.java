//
// Translated by CS2J (http://www.cs2j.com): 2/15/2016 7:59:25 PM
//
...
import OpenDental.UI.ComboBoxMulti;
...
* 
*/
public class FormPatientEdit  extends System.Windows.Forms.Form 
{
    ...
    private System.Windows.Forms.TextBox textMiddleI = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox textPreferred = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textSalutation = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textSchool = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.RadioButton radioStudentN = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioStudentP = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioStudentF = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.Label labelSchoolName = new System.Windows.Forms.Label();
    ...
    private System.Windows.Forms.CheckBox checkSame = new System.Windows.Forms.CheckBox();
    ...
    private System.Windows.Forms.GroupBox groupNotes = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.CheckBox checkNotesSame = new System.Windows.Forms.CheckBox();
    ...
    private System.Windows.Forms.ListBox listGender = new System.Windows.Forms.ListBox();
    private System.Windows.Forms.ListBox listPosition = new System.Windows.Forms.ListBox();
    ...
    private System.Windows.Forms.Label labelSSN = new System.Windows.Forms.Label();
    ...
    private System.Windows.Forms.Label labelRaceEthnicity = new System.Windows.Forms.Label();
    ...
    private System.Windows.Forms.GroupBox groupPH = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.TextBox textCounty = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label35 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textSite = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.ComboBox comboGradeLevel = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.ComboBox comboUrgency = new System.Windows.Forms.ComboBox();
    /**
    * Set true if this is a new patient. Patient must have been already inserted. If users clicks cancel, this patient will be deleted.
    */
    public boolean IsNew = new boolean();
    private System.Windows.Forms.ListBox listSites = new System.Windows.Forms.ListBox();
    //displays dropdown for Sites
    private String SiteOriginal = new String();
    private boolean mouseIsInListSites = new boolean();
    private List<Site> listSitesFiltered = new List<Site>();
    private System.Windows.Forms.ListBox listCounties = new System.Windows.Forms.ListBox();
    //displays dropdown for GradeSchools
    private String countyOriginal = new String();
    private OpenDental.ValidDate textDateFirstVisit;
    private System.Windows.Forms.Label label36 = new System.Windows.Forms.Label();
    private boolean mouseIsInListCounties = new boolean();
    ...
    /**
    * This is the object that is altered in this form.
    */
    ...
    private TextBox textTrophyFolder = new TextBox();
    private Label labelTrophyFolder = new Label();
    private TextBox textWard = new TextBox();
    private Label labelWard = new Label();
    private Label label28 = new Label();
    private ComboBox comboLanguage = new ComboBox();
    ...
    private ComboBox comboFeeSched = new ComboBox();
    private ComboBox comboSecProv = new ComboBox();
    private ComboBox comboPriProv = new ComboBox();
    private ComboBox comboContact = new ComboBox();
    private Label label23 = new Label();
    private ComboBox comboConfirm = new ComboBox();
    private Label label24 = new Label();
    private ComboBox comboRecall = new ComboBox();
    private Label label25 = new Label();
    private OpenDental.ValidDate textAdmitDate;
    private Label labelAdmitDate = new Label();
    ...
    private Label labelCanadianEligibilityCode = new Label();
    private ComboBox comboCanadianEligibilityCode = new ComboBox();
    private Label label41 = new Label();
    private ListBox listRelationships = new ListBox();
    private OpenDental.UI.Button butAddGuardian;
    /**
    * Will include the languages setup in the settings, and also the language of this patient if that language is not on the selection list.
    */
    private List<String> languageList = new List<String>();
    private OpenDental.UI.Button butGuardianDefaults;
    private TextBox textAskToArriveEarly = new TextBox();
    private Label label42 = new Label();
    private CheckBox checkArriveEarlySame = new CheckBox();
    private Label label43 = new Label();
    private Label label10 = new Label();
    private ListBox listTextOk = new ListBox();
    private ComboBoxMulti comboBoxMultiRace;
    private ComboBox comboEthnicity = new ComboBox();
    private Label labelEthnicity = new Label();
    private TextBox textCountry = new TextBox();
    private TextBox textMotherMaidenFname = new TextBox();
    private Label labelMotherMaidenFname = new Label();
    private TextBox textMotherMaidenLname = new TextBox();
    private Label labelMotherMaidenLname = new Label();
    private List<Guardian> GuardianList = new List<Guardian>();
    private Label label30 = new Label();
    private TextBox textDateDeceased = new TextBox();
    private EhrPatient _ehrPatientCur;
    /**
    * 
    */
    public FormPatientEdit(Patient patCur, Family famCur) throws Exception {
        initializeComponent();
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormPatientEdit.class);
        ...
        // butEditZip
        //
        this.butEditZip.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butEditZip.setAutosize(true);
        this.butEditZip.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butEditZip.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butEditZip.setCornerRadius(4F);
        ...
        // butAuto
        //
        this.butAuto.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butAuto.setAutosize(true);
        this.butAuto.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butAuto.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butAuto.setCornerRadius(4F);
        ...
        this.comboBoxMultiRace.setDroppedDown(false);
        this.comboBoxMultiRace.setItems(((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiRace.Items"))));
        this.comboBoxMultiRace.Location = new System.Drawing.Point(195, 17);
        this.comboBoxMultiRace.Name = "comboBoxMultiRace";
        this.comboBoxMultiRace.setSelectedIndices(((System.Collections.ArrayList)(resources.GetObject("comboBoxMultiRace.SelectedIndices"))));
        this.comboBoxMultiRace.Size = new System.Drawing.Size(155, 21);
        this.comboBoxMultiRace.TabIndex = 1;
        this.comboBoxMultiRace.setUseCommas(true);
        //
        // comboEthnicity
        //
        ...
        this.butPickSite.setCornerRadius(4F);
        ...
        // butAddGuardian
        //
        this.butAddGuardian.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butAddGuardian.setAutosize(true);
        this.butAddGuardian.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butAddGuardian.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butAddGuardian.setCornerRadius(4F);
        ...
        // butGuardianDefaults
        //
        this.butGuardianDefaults.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butGuardianDefaults.setAutosize(true);
        this.butGuardianDefaults.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butGuardianDefaults.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butGuardianDefaults.setCornerRadius(4F);
        ...
        this.listTextOk.Items.AddRange(new Object[]{ "??", "Yes", "No" });
    ...
    private void formPatientEdit_Load(Object sender, System.EventArgs e) throws Exception {
        fillComboZip();
        ...
        if (PatCur != null)
        {
            ...
            {
                if (!StringSupport.equals(PatCur.HmPhone, FamCur.ListPats[i].HmPhone) || !StringSupport.equals(PatCur.Address, FamCur.ListPats[i].Address) || !StringSupport.equals(PatCur.Address2, FamCur.ListPats[i].Address2) || !StringSupport.equals(PatCur.City, FamCur.ListPats[i].City) || !StringSupport.equals(PatCur.State, FamCur.ListPats[i].State) || !StringSupport.equals(PatCur.Zip, FamCur.ListPats[i].Zip) || !StringSupport.equals(PatCur.CreditType, FamCur.ListPats[i].CreditType) || PatCur.BillingType != FamCur.ListPats[i].BillingType || PatCur.PriProv != FamCur.ListPats[i].PriProv || PatCur.SecProv != FamCur.ListPats[i].SecProv || PatCur.FeeSched != FamCur.ListPats[i].FeeSched)
                {
                    checkSame.Checked = false;
                }
                 
                if (!StringSupport.equals(PatCur.AddrNote, FamCur.ListPats[i].AddrNote))
                {
        ...
        {
            //Show mother's maiden name UI if using EHR.
        ...
        switch(PatCur.Position)
        {
            ...
            case Child: 
                ...
                break;
            case Widowed: 
                listPosition.SelectedIndex = 3;
                break;
            case Divorced: 
                listPosition.SelectedIndex = 4;
                break;
        ...
        //if USA
        //the null catches new patients
        if (StringSupport.equals(CultureInfo.CurrentCulture.Name, "en-US") && PatCur.SSN != null && PatCur.SSN.Length == 9)
        {
            //and length exactly 9 (no data gets lost in formatting)
            textSSN.Text = PatCur.SSN.Substring(0, 3) + "-" + PatCur.SSN.Substring(3, 2) + "-" + PatCur.SSN.Substring(5, 4);
        }
        else
        {
        ...
        listTextOk.SelectedIndex = ((Enum)PatCur.TxtMsgOk).ordinal();
        ...
        if (!StringSupport.equals(PatCur.Language, "") && PatCur.Language != null && !languageList.Contains(PatCur.Language))
        {
            languageList.Add(PatCur.Language);
        }
         
        comboLanguage.Items.Add(Lan.g(this,"none"));
        //regardless of how many languages are listed, the first item is "none"
        comboLanguage.SelectedIndex = 0;
        for (int i = 0;i < languageList.Count;i++)
        {
            if (StringSupport.equals(languageList[i], ""))
            {
                continue;
            }
            ...
            if (StringSupport.equals(PatCur.Language, languageList[i]))
            {
        ...
        {
            comboPriProv.Items.Add(ProviderC.getListShort()[i].Abbr);
            if (ProviderC.getListShort()[i].ProvNum == PatCur.PriProv)
            {
        ...
        for (int i = 0;i < ProviderC.getListShort().Count;i++)
        {
            comboSecProv.Items.Add(ProviderC.getListShort()[i].Abbr);
            if (ProviderC.getListShort()[i].ProvNum == PatCur.SecProv)
        ...
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()].Length;i++)
        {
            ...
            if (DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()][i].DefNum == PatCur.BillingType)
        ...
        for (int i = 0;i < Clinics.getList().Length;i++)
        {
            ...
            if (Clinics.getList()[i].ClinicNum == PatCur.ClinicNum)
            {
                comboClinic.SelectedIndex = i + 1;
            }
             
        }
        System.String __dummyScrutVar3 = PatCur.StudentStatus;
        //non
        if (__dummyScrutVar3.equals("N") || __dummyScrutVar3.equals(""))
        {
        ...
        comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","none"));
        //0 none option for both regular and EHR users.
        if (PrefC.getBool(PrefName.ShowFeatureEhr))
        {
            labelRaceEthnicity.Text = "Race";
            //comboBoxMultiRace.Items.Add(Lan.g("enumPatRace","Aboriginal"));//Hidden for EHR
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","AfricanAmerican"));
            //1
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","AmericanIndian"));
            //2
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Asian"));
            //3
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","DeclinedToSpecify"));
            //4
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","HawaiiOrPacIsland"));
            //5
            ...
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Other"));
            //6
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","White"));
            //7
            comboEthnicity.Items.Add(Lan.g(this,"none"));
            //0
            comboEthnicity.Items.Add(Lan.g(this,"DeclinedToSpecify"));
            //1
            comboEthnicity.Items.Add(Lan.g(this,"Not Hispanic"));
            //2
            comboEthnicity.Items.Add(Lan.g(this,"Hispanic"));
            //3
            ...
            for (int i = 0;i < listPatRaces.Count;i++)
            {
                ...
                {
                    comboBoxMultiRace.setSelected(1,true);
                }
                else //AfricanAmerican
                if (race == PatRace.AmericanIndian)
                {
                    comboBoxMultiRace.setSelected(2,true);
                }
                else //AmericanIndian
                if (race == PatRace.Asian)
                {
                    comboBoxMultiRace.setSelected(3,true);
                }
                else //Asian
                if (race == PatRace.DeclinedToSpecifyRace)
                {
                    comboBoxMultiRace.setSelected(4,true);
                }
                else //DeclinedToSpecify
                if (race == PatRace.HawaiiOrPacIsland)
                {
                    comboBoxMultiRace.setSelected(5,true);
                }
                else //HawaiiOrPacIsland
                if (race == PatRace.Hispanic)
                {
                    comboEthnicity.SelectedIndex = 3;
                }
                else //Hispanic
                if (race == PatRace.NotHispanic)
                {
                    comboEthnicity.SelectedIndex = 2;
                }
                else //Not Hispanic
                if (race == PatRace.Other)
                {
                    comboBoxMultiRace.setSelected(6,true);
                }
                else //Other
                if (race == PatRace.White)
                {
                    comboBoxMultiRace.setSelected(7,true);
                }
                else //White
                if (race == PatRace.DeclinedToSpecifyEthnicity)
                {
        ...
        else
        {
            //DeclinedToSpecify
            //EHR not enabled
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Aboriginal"));
            //1
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","AfricanAmerican"));
            //2
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","AmericanIndian"));
            ...
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","HawaiiOrPacIsland"));
            //6
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Hispanic"));
            //7
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Multiracial"));
            //8
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","Other"));
            //9
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","White"));
            //10
            comboBoxMultiRace.getItems().Add(Lan.g("enumPatRace","NotHispanic"));
            //11
            List<int> listPatRaces = PatientRaces.getPatRaceList(PatCur.PatNum);
            for (int i = 0;i < listPatRaces.Count;i++)
            {
                comboBoxMultiRace.SetSelected(listPatRaces[i] + 1, true);
            }
            //Offset by 1 because of none option at location 0.
            labelEthnicity.Visible = false;
            comboEthnicity.Visible = false;
        } 
        if (comboBoxMultiRace.getSelectedIndices().Count == 0)
        {
            //no race set
        ...
        String[] enumGrade = Enum.GetNames(PatientGrade.class);
        for (int i = 0;i < enumGrade.Length;i++)
        {
            comboGradeLevel.Items.Add(Lan.g("enumGrade", enumGrade[i]));
        }
        comboGradeLevel.SelectedIndex = ((Enum)PatCur.GradeLevel).ordinal();
        String[] enumUrg = Enum.GetNames(TreatmentUrgency.class);
        for (int i = 0;i < enumUrg.Length;i++)
        {
            comboUrgency.Items.Add(Lan.g("enumUrg", enumUrg[i]));
        }
        comboUrgency.SelectedIndex = ((Enum)PatCur.Urgency).ordinal();
        ...
        {
            comboContact.Items.Add(Lan.g("enumContactMethod", Enum.GetNames(ContactMethod.class)[i]));
            comboConfirm.Items.Add(Lan.g("enumContactMethod", Enum.GetNames(ContactMethod.class)[i]));
            comboRecall.Items.Add(Lan.g("enumContactMethod", Enum.GetNames(ContactMethod.class)[i]));
        }
        comboContact.SelectedIndex = ((Enum)PatCur.PreferContactMethod).ordinal();
        comboConfirm.SelectedIndex = ((Enum)PatCur.PreferConfirmMethod).ordinal();
        comboRecall.SelectedIndex = ((Enum)PatCur.PreferRecallMethod).ordinal();
        ...
        {
            if (HL7Defs.getOneDeepEnabled().ShowDemographics == HL7ShowDemographics.Show)
            {
                //If show, then not edit so disable OK button
                butOK.Enabled = false;
            }
    ...
    private void fillGuardians() throws Exception {
        GuardianList = Guardians.refresh(PatCur.PatNum);
        listRelationships.Items.Clear();
        for (int i = 0;i < GuardianList.Count;i++)
        {
            listRelationships.Items.Add(FamCur.GetNameInFamFirst(GuardianList[i].PatNumGuardian) + " " + Guardians.GetGuardianRelationshipStr(GuardianList[i].Relationship));
        }
    }
    ...
    private void textMiddleI_TextChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void textPreferred_TextChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void textSalutation_TextChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void radioStudentN_Click(Object sender, System.EventArgs e) throws Exception {
        PatCur.StudentStatus = "N";
    }

    private void radioStudentF_Click(Object sender, System.EventArgs e) throws Exception {
        PatCur.StudentStatus = "F";
    }

    private void radioStudentP_Click(Object sender, System.EventArgs e) throws Exception {
        PatCur.StudentStatus = "P";
    }

    private void textSSN_Validating(Object sender, System.ComponentModel.CancelEventArgs e) throws Exception {
        ...
        if (StringSupport.equals(textSSN.Text, ""))
        {
            return ;
        }
         
        if (textSSN.Text.Length == 9)
        {
            ...
            if (SSNisValid)
            {
                textSSN.Text = textSSN.Text.Substring(0, 3) + "-" + textSSN.Text.Substring(3, 2) + "-" + textSSN.Text.Substring(5, 4);
            }
    ...
    private void textCreditType_TextChanged(Object sender, System.EventArgs e) throws Exception {
        textCreditType.Text = textCreditType.Text.ToUpper();
        textCreditType.SelectionStart = 1;
    }

    private void textBirthdate_Validated(Object sender, System.EventArgs e) throws Exception {
        calcAge();
    }

    private void textDateDeceased_Validated(Object sender, EventArgs e) throws Exception {
        calcAge();
    }

    private void calcAge() throws Exception {
        textAge.Text = "";
        if (!StringSupport.equals(textBirthdate.errorProvider1.GetError(textBirthdate), ""))
        {
            return ;
        }
        ...
        if (!StringSupport.equals(textDateDeceased.Text, ""))
        {
            try
            {
    ...
    private void butEditZip_Click(Object sender, System.EventArgs e) throws Exception {
    ...
    private void butAuto_Click(Object sender, System.EventArgs e) throws Exception {
        try
        {
    ...
    private void textCounty_KeyUp(Object sender, System.Windows.Forms.KeyEventArgs e) throws Exception {
        ...
        if (StringSupport.equals(textCounty.Text, ""))
        {
            listCounties.Visible = false;
            return ;
        }
        ...
        countyOriginal = textCounty.Text;
    ...
    private void textCounty_Leave(Object sender, System.EventArgs e) throws Exception {
    ...
    private void listCounties_Click(Object sender, System.EventArgs e) throws Exception {
        textCounty.Text = CountiesList[listCounties.SelectedIndex].CountyName;
        textCounty.Focus();
        textCounty.SelectionStart = textCounty.Text.Length;
        listCounties.Visible = false;
    ...
    private void listCounties_MouseEnter(Object sender, System.EventArgs e) throws Exception {
        mouseIsInListCounties = true;
    }

    private void listCounties_MouseLeave(Object sender, System.EventArgs e) throws Exception {
        mouseIsInListCounties = false;
    }

    private void textSite_KeyUp(Object sender, System.Windows.Forms.KeyEventArgs e) throws Exception {
        if (e.KeyCode == Keys.Return)
        {
            listSites.Visible = false;
            comboGradeLevel.Focus();
        ...
        if (StringSupport.equals(textSite.Text, ""))
        {
            listSites.Visible = false;
            return ;
        }
    ...
    private void textSite_Leave(Object sender, System.EventArgs e) throws Exception {
    ...
    private void listSites_Click(Object sender, System.EventArgs e) throws Exception {
        textSite.Text = listSitesFiltered[listSites.SelectedIndex].Description;
        PatCur.SiteNum = listSitesFiltered[listSites.SelectedIndex].SiteNum;
        textSite.Focus();
        textSite.SelectionStart = textSite.Text.Length;
    ...
    private void listSites_MouseEnter(Object sender, System.EventArgs e) throws Exception {
        mouseIsInListSites = true;
    }

    private void listSites_MouseLeave(Object sender, System.EventArgs e) throws Exception {
    ...
    private void listPosition_SelectedIndexChanged(Object sender, EventArgs e) throws Exception {
    }

    //CheckGuardianUiState();
    private void listRelationships_DoubleClick(Object sender, EventArgs e) throws Exception {
    ...
    private void butAddGuardian_Click(Object sender, EventArgs e) throws Exception {
        Guardian guardian = new Guardian();
        guardian.setIsNew(true);
    ...
    private void butGuardianDefaults_Click(Object sender, EventArgs e) throws Exception {
        ...
        PatientPosition pos = PatientPosition.Single;
    ...
    */
    private void getEmployerNum() throws Exception {
        ...
        else
        {
            ...
            if (!StringSupport.equals(Employers.getName(PatCur.EmployerNum), textEmployer.Text))
            {
                PatCur.EmployerNum = Employers.GetEmployerNum(textEmployer.Text);
            }
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        boolean CDSinterventionCheckRequired = false;
        //checks selected values
        if (!StringSupport.equals(textBirthdate.errorProvider1.GetError(textBirthdate), "") || !StringSupport.equals(textDateFirstVisit.errorProvider1.GetError(textDateFirstVisit), "") || !StringSupport.equals(textAdmitDate.errorProvider1.GetError(textAdmitDate), ""))
        {
        ...
        if (!StringSupport.equals(textChartNumber.Text, ""))
        {
        ...
        if (!StringSupport.equals(textCounty.Text, "") && !Counties.DoesExist(textCounty.Text))
        {
        ...
        if (!StringSupport.equals(textSite.Text, "") && !StringSupport.equals(textSite.Text, Sites.getDescription(PatCur.SiteNum)))
        {
        ...
        if (CultureInfo.CurrentCulture.Name.EndsWith("CA"))
        {
            //Canadian. en-CA or fr-CA
            //FT student
            if (comboCanadianEligibilityCode.SelectedIndex == 1 && StringSupport.equals(textSchool.Text, "") && PIn.Date(textBirthdate.Text).AddYears(18) <= DateTime.Today)
            {
        ...
        if (PrefC.getBool(PrefName.DockPhonePanelShow) && Resellers.isResellerFamily(PatCur.Guarantor) && PatOld.PatStatus != (PatientStatus)listStatus.SelectedIndex)
        {
        ...
        if (PrefC.getBool(PrefName.ShowFeatureEhr))
        {
            //Mother's maiden name UI is only used when EHR is enabled.
        ...
        SelectedIndex __dummyScrutVar4 = listStatus.SelectedIndex;
        ...
        SelectedIndex __dummyScrutVar5 = listGender.SelectedIndex;
        if (__dummyScrutVar5.equals(0))
        {
            PatCur.Gender = PatientGender.Male;
        }
        else if (__dummyScrutVar5.equals(1))
        {
            PatCur.Gender = PatientGender.Female;
        }
        ...
        SelectedIndex __dummyScrutVar6 = listPosition.SelectedIndex;
        if (__dummyScrutVar6.equals(0))
        {
            PatCur.Position = PatientPosition.Single;
        }
        else if (__dummyScrutVar6.equals(1))
        {
            PatCur.Position = PatientPosition.Married;
        }
        ...
        {
            PatCur.Position = PatientPosition.Divorced;
        }
        ...
        if (StringSupport.equals(CultureInfo.CurrentCulture.Name, "en-US"))
        {
            if (Regex.IsMatch(textSSN.Text, "^\\d\\d\\d-\\d\\d-\\d\\d\\d\\d$"))
            {
                PatCur.SSN = textSSN.Text.Substring(0, 3) + textSSN.Text.Substring(4, 2) + textSSN.Text.Substring(7, 4);
            }
            else
            {
        ...
        if (IsNew)
        {
            ...
            for (int i = 0;i < patList.Count;i++)
            {
                ...
                if (patList[i].Birthdate == PatCur.Birthdate || patList[i].Birthdate.Year < 1880 || PatCur.Birthdate.Year < 1880)
                {
        ...
        if (comboPriProv.SelectedIndex != -1)
        {
            PatCur.PriProv = ProviderC.getListShort()[comboPriProv.SelectedIndex].ProvNum;
        }
        ...
        {
            PatCur.SecProv = ProviderC.getListShort()[comboSecProv.SelectedIndex - 1].ProvNum;
        } 
        ...
        if (comboBillType.SelectedIndex != -1)
        {
            PatCur.BillingType = DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()][comboBillType.SelectedIndex].DefNum;
        }
        ...
        {
            PatCur.ClinicNum = Clinics.getList()[comboClinic.SelectedIndex - 1].ClinicNum;
        } 
        List<PatRace> listPatRaces = new List<PatRace>();
        for (int i = 0;i < comboBoxMultiRace.getSelectedIndices().Count;i++)
        {
            int selectedIdx = (int)comboBoxMultiRace.getSelectedIndices()[i];
            if (selectedIdx == 0)
            {
                //If the none option was chosen, then ensure that no other race information is saved.
                listPatRaces.Clear();
                break;
            }
            ...
            if (!PrefC.getBool(PrefName.ShowFeatureEhr))
            {
                //If not using EHR, then the comboBoxMultiRace item locations are the same as the PatRace enum locations plus 1.
                listPatRaces.Add(PatRace.values()[(selectedIdx - 1)]);
                continue;
            }
        ...
        if (listPatRaces.Contains(PatRace.DeclinedToSpecifyRace))
        {
            //If DeclinedToSpecify was chosen, then ensure that no other races are saved.
            listPatRaces.Clear();
            listPatRaces.Add(PatRace.DeclinedToSpecifyRace);
        }
        else if (listPatRaces.Contains(PatRace.Other))
        {
            //If Other was chosen, then ensure that no other races are saved.
            listPatRaces.Clear();
            listPatRaces.Add(PatRace.Other);
        }
        ...
        PatientRaces.Reconcile(PatCur.PatNum, listPatRaces);
        ...
        if (CDSinterventionCheckRequired && CDSPermissions.getForUser(Security.getCurUser().UserNum).ShowCDS && CDSPermissions.getForUser(Security.getCurUser().UserNum).LabTestCDS)
        {
            FormCDSIntervention FormCDSI = new FormCDSIntervention();
            FormCDSI.ListCDSI = EhrTriggers.triggerMatch(PatCur,PatCur);
            //both should be patCur.
        ...
        for (int i = 0;i < Referrals.getList().Length;i++)
        {
            ...
            if (Referrals.getList()[i].PatNum == PatCur.PatNum)
            {
                //Referrals.Cur=Referrals.List[i];
                Referrals.getList()[i].LName = PatCur.LName;
                Referrals.getList()[i].FName = PatCur.FName;
                Referrals.getList()[i].MName = PatCur.MiddleI;
                Referrals.getList()[i].Address = PatCur.Address;
                Referrals.getList()[i].Address2 = PatCur.Address2;
                Referrals.getList()[i].City = PatCur.City;
                Referrals.getList()[i].ST = PatCur.State;
                Referrals.getList()[i].SSN = PatCur.SSN;
                Referrals.getList()[i].Zip = PatCur.Zip;
                Referrals.getList()[i].Telephone = TelephoneNumbers.formatNumbersExactTen(PatCur.HmPhone);
                Referrals.getList()[i].EMail = PatCur.Email;
        ...
        if (PatCur.PatStatus == PatientStatus.Archived || PatCur.PatStatus == PatientStatus.Deceased || PatCur.PatStatus == PatientStatus.Inactive || PatCur.PatStatus == PatientStatus.NonPatient || PatCur.PatStatus == PatientStatus.Prospective)
        {
        ...
        else //if patient was re-activated, then re-enable any recalls
        if (PatCur.PatStatus != PatOld.PatStatus && PatCur.PatStatus == PatientStatus.Patient)
        {
    ...
    private void formPatientEdit_Closing(Object sender, System.ComponentModel.CancelEventArgs e) throws Exception {
