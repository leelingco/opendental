...
import OpenDental.FormPatListElementEdit2014;
import OpenDental.FormPatListResults2014;
...
public class FormPatList2014  extends Form 
{

    public List<EhrPatListElement2014> ElementList = new List<EhrPatListElement2014>();
    public FormPatList2014() throws Exception {
        initializeComponent();
    }
    ...
    private void fillGrid() throws Exception {
        ...
        for (int i = 0;i < ElementList.Count;i++)
        {
            ...
            if (ElementList[i].Restriction == EhrRestrictionType.Gender || ElementList[i].Restriction == EhrRestrictionType.Problem || ElementList[i].Restriction == EhrRestrictionType.Medication || ElementList[i].Restriction == EhrRestrictionType.CommPref || ElementList[i].Restriction == EhrRestrictionType.Allergy)
            {
                row.getCells().add("");
            }
            else
            ...
            {
                row.getCells().Add(ElementList[i].StartDate.ToShortDateString());
            }
            else
            {
                row.getCells().add("");
            ...
            {
                row.getCells().Add(ElementList[i].EndDate.ToShortDateString());
            }
            else
            {
                row.getCells().add("");
