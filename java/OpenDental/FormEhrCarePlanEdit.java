...
public class FormEhrCarePlanEdit  extends Form 
{

    private EhrCarePlan _ehrCarePlan;
    private Snomed _snomedGoal;
    public FormEhrCarePlanEdit(EhrCarePlan ehrCarePlan) throws Exception {
        initializeComponent();
        Lan.F(this);
        _ehrCarePlan = ehrCarePlan;
    }

    private void formEhrCarePlanEdit_Load(Object sender, EventArgs e) throws Exception {
        textDate.Text = _ehrCarePlan.DatePlanned.ToShortDateString();
        _snomedGoal = null;
        if (!String.IsNullOrEmpty(_ehrCarePlan.SnomedEducation))
        {
            //Blank if new
    ...
    private void butSnomedGoalSelect_Click(Object sender, EventArgs e) throws Exception {
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormEhrCarePlanEdit.class);
        ...
        // butSnomedGoalSelect
        //
        this.butSnomedGoalSelect.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butSnomedGoalSelect.setAutosize(true);
        this.butSnomedGoalSelect.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butSnomedGoalSelect.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butSnomedGoalSelect.setCornerRadius(4F);
    ...
    private System.Windows.Forms.TextBox textSnomedGoal = new System.Windows.Forms.TextBox();
    private OpenDental.UI.Button butSnomedGoalSelect;
