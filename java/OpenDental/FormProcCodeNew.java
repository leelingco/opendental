...
* 
*/
public class FormProcCodeNew  extends System.Windows.Forms.Form 
{
    ...
    * 
    */
    public System.Windows.Forms.TextBox textNewCode = new System.Windows.Forms.TextBox();
    private OpenDental.UI.Button butAnother;
    private Label label2 = new Label();
    public TextBox textDescription = new TextBox();
    private Label label3 = new Label();
    private ListBox listType = new ListBox();
    private Label label4 = new Label();
    public TextBox textAbbreviation = new TextBox();
    private CheckBox checkNoBillIns = new CheckBox();
    private CheckBox checkIsHygiene = new CheckBox();
    private CheckBox checkIsProsth = new CheckBox();
    private Label label5 = new Label();
    private ComboBox comboPaintType = new ComboBox();
    private ComboBox comboTreatArea = new ComboBox();
    private Label label6 = new Label();
    private ComboBox comboCategory = new ComboBox();
    private Label label7 = new Label();
    private System.ComponentModel.Container components = null;
    private Label label8 = new Label();
    public TextBox textCodePrevious = new TextBox();
    ...
    * 
    */
    public FormProcCodeNew() throws Exception {
        initializeComponent();
        Lan.f(this);
    }
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormProcCodeNew.class);
        ...
        // butAnother
        //
        this.butAnother.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        ...
        this.butAnother.setAutosize(true);
        this.butAnother.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butAnother.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butAnother.setCornerRadius(4F);
    ...
    private void formProcCodeNew_Load(Object sender, EventArgs e) throws Exception {
        ...
        {
            comboPaintType.Items.Add(Enum.GetNames(ToothPaintingType.class)[i]);
        }
        comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.None).ordinal();
        for (int i = 1;i < Enum.GetNames(TreatmentArea.class).Length;i++)
        {
            comboTreatArea.Items.Add(Lan.g(this, Enum.GetNames(TreatmentArea.class)[i]));
        }
        comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Mouth).ordinal() - 1;
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.ProcCodeCats).ordinal()].Length;i++)
        {
            comboCategory.Items.Add(DefC.getShort()[((Enum)DefCat.ProcCodeCats).ordinal()][i].ItemName);
        }
    ...
    private void textNewCode_TextChanged(Object sender, System.EventArgs e) throws Exception {
        if (StringSupport.equals(textNewCode.Text, "d"))
        {
            textNewCode.Text = "D";
    ...
    private void listType_Click(Object sender, EventArgs e) throws Exception {
        if (StringSupport.equals(CultureInfo.CurrentCulture.Name, "en-US") && listType.SelectedIndex != 0)
        {
            textNewCode.Text = "D";
        }
        else
        ...
        comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Mouth).ordinal() - 1;
        comboCategory.SelectedIndex = 0;
        SelectedIndex __dummyScrutVar0 = listType.SelectedIndex;
        ...
        else if (__dummyScrutVar0.equals(5))
        {
            ...
            checkIsHygiene.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.Sealant).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
        ...
        else if (__dummyScrutVar0.equals(6))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.FillingDark).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Surf).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Fillings");
        }
        else if (__dummyScrutVar0.equals(7))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.FillingLight).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Surf).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Fillings");
        }
        ...
        else if (__dummyScrutVar0.equals(9))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.PostBU).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Fillings");
        }
        ...
        else if (__dummyScrutVar0.equals(11))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.RCT).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Endo");
        }
        else if (__dummyScrutVar0.equals(12))
        {
            ...
            checkIsHygiene.Checked = true;
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Quad).ordinal() - 1;
        ...
        else if (__dummyScrutVar0.equals(13))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.DentureLight).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Arch).ordinal() - 1;
        ...
        else if (__dummyScrutVar0.equals(14))
        {
            ...
            checkIsProsth.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.DentureLight).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.ToothRange).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Dentures");
        }
        ...
        else if (__dummyScrutVar0.equals(20))
        {
            ...
            checkIsProsth.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.CrownLight).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
        ...
        else if (__dummyScrutVar0.equals(22))
        {
            ...
            checkIsProsth.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.CrownDark).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Crown & Bridge");
        }
        else if (__dummyScrutVar0.equals(23))
        {
            //Bridge Pontic or Retainer - Ceramic
            textDescription.Text = "Bridge Pontic, Ceramic";
            textAbbreviation.Text = "PontCeram";
            checkIsProsth.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.BridgeLight).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Crown & Bridge");
        }
        else if (__dummyScrutVar0.equals(24))
        {
            //Bridge Pontic or Retainer - PFM
        ...
        {
            //Bridge Pontic or Retainer - Metal
            textDescription.Text = "Bridge Pontic, Cast Noble Metal";
            textAbbreviation.Text = "PontCastNM";
            checkIsProsth.Checked = true;
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.BridgeDark).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
            comboCategory.SelectedIndex = getCategoryIndex("Crown & Bridge");
        }
        else if (__dummyScrutVar0.equals(26))
        {
            ...
            comboPaintType.SelectedIndex = ((Enum)ToothPaintingType.Extraction).ordinal();
            comboTreatArea.SelectedIndex = ((Enum)TreatmentArea.Tooth).ordinal() - 1;
    ...
    /**
    * Returns the index of the category with the supplied name.  Zero if the name does not exist.
    */
    private int getCategoryIndex(String name) throws Exception {
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.ProcCodeCats).ordinal()].Length;i++)
        {
            if (StringSupport.equals(DefC.getShort()[((Enum)DefCat.ProcCodeCats).ordinal()][i].ItemName, name))
            {
                return i;
            }
    ...
    private boolean addProc() throws Exception {
        if (StringSupport.equals(textNewCode.Text, ""))
        {
        ...
        if (StringSupport.equals(textAbbreviation.Text, ""))
        {
        ...
        code.ProcCat = DefC.getShort()[((Enum)DefCat.ProcCodeCats).ordinal()][comboCategory.SelectedIndex].DefNum;
    ...
    private void butDefault_Click(Object sender, EventArgs e) throws Exception {
        Changed = true;
        //because of add definition for new proc category
    ...
    private void butAnother_Click(Object sender, EventArgs e) throws Exception {
