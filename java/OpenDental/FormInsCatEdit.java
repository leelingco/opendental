...
* 
*/
public class FormInsCatEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private ComboBox comboCat = new ComboBox();
    private Label label4 = new Label();
    /**
    * A list of CovSpans just for this category
    */
    ...
    * 
    */
    public FormInsCatEdit(CovCat covCatCur) throws Exception {
        initializeComponent();
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormInsCatEdit.class);
    ...
    private void formInsCatEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        textPercent.setMaxVal(100);
        checkHidden.Checked = CovCatCur.IsHidden;
        for (int i = 0;i < Enum.GetNames(EbenefitCategory.class).Length;i++)
        {
            comboCat.Items.Add(Enum.GetNames(EbenefitCategory.class)[i]);
            if (Enum.GetNames(EbenefitCategory.class)[i] == CovCatCur.EbenefitCat.ToString())
            {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textPercent.errorProvider1.GetError(textPercent), ""))
        {
