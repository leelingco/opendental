...
*/
public class FormCarrierEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.Label labelElectID = new System.Windows.Forms.Label();
    ...
    private System.Windows.Forms.ComboBox comboPlans = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.TextBox textPlans = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.Label labelCitySt = new System.Windows.Forms.Label();
    /**
    * 
    */
    public boolean IsNew = new boolean();
    private CheckBox checkIsCDAnet = new CheckBox();
    private GroupBox groupCDAnet = new GroupBox();
    private TextBox textModemReconcile = new TextBox();
    private Label label10 = new Label();
    private TextBox textModemSummary = new TextBox();
    private Label label8 = new Label();
    private TextBox textModem = new TextBox();
    private Label label7 = new Label();
    private ComboBox comboNetwork = new ComboBox();
    private Label label5 = new Label();
    private TextBox textVersion = new TextBox();
    private Label label1 = new Label();
    private GroupBox groupBox3 = new GroupBox();
    private CheckBox check08 = new CheckBox();
    private CheckBox check03 = new CheckBox();
    private CheckBox check07 = new CheckBox();
    private CheckBox check06 = new CheckBox();
    private CheckBox check04 = new CheckBox();
    private CheckBox check05 = new CheckBox();
    private CheckBox check02 = new CheckBox();
    private CheckBox checkIsHidden = new CheckBox();
    private Label label11 = new Label();
    private CheckBox check03m = new CheckBox();
    private Label label12 = new Label();
    private TextBox textEncryptionMethod = new TextBox();
    private Label label13 = new Label();
    private CheckBox check01 = new CheckBox();
    private Label label14 = new Label();
    public Carrier CarrierCur;
    /**
    * 
    */
    public FormCarrierEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormCarrierEdit.class);
        ...
        // groupCDAnet
        //
        this.groupCDAnet.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
        ...
        this.label14.Text = "The values in this section can be set by running database maint after manually se" + "tting the carrier identification number above.";
    ...
    private void formCarrierEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        checkIsCDAnet.Checked = CarrierCur.IsCDA;
        //Can be checked but not visible.
        ...
        for (int i = 0;i < CanadianNetworks.getListt().Count;i++)
        {
            comboNetwork.Items.Add(CanadianNetworks.getListt()[i].Abbrev + " - " + CanadianNetworks.getListt()[i].Descript);
            if (CarrierCur.CanadianNetworkNum == CanadianNetworks.getListt()[i].CanadianNetworkNum)
            {
    ...
    private void textCarrierName_TextChanged(Object sender, System.EventArgs e) throws Exception {
    ...
    private void textState_TextChanged(Object sender, System.EventArgs e) throws Exception {
        ...
        if (StringSupport.equals(CultureInfo.CurrentCulture.Name, "en-US") || StringSupport.equals(CultureInfo.CurrentCulture.Name, "en-CA"))
        {
    ...
    private void checkIsCDAnet_Click(Object sender, EventArgs e) throws Exception {
        groupCDAnet.Visible = checkIsCDAnet.Checked;
    }
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        else
        {
            try
            {
                ...
                if (!StringSupport.equals(carrierNameOld, CarrierCur.CarrierName))
                {
                    List<long> insPlanNums = InsPlans.getPlanNumsByCarrierNum(CarrierCur.CarrierNum);
                    for (int i = 0;i < insPlanNums.Count;i++)
                    {
                        SecurityLogs.MakeLogEntry(Permissions.InsPlanChangeCarrierName, 0, Lan.g(this,"Carrier name changed in Edit Carrier window from") + " " + carrierNameOld + " " + Lan.g(this,"to") + " " + CarrierCur.CarrierName, insPlanNums[i]);
                    }
                }
