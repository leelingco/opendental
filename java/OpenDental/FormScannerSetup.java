...
* 
*/
public class FormScannerSetup  extends System.Windows.Forms.Form 
{
    ...
    private OpenDental.ValidNum textDoc;
    /**
    * 
    */
    public FormScannerSetup() throws Exception {
        initializeComponent();
        //too many labels to use Lan.F()
        Lan.C(this, new System.Windows.Forms.Control[]{ this, this.groupBox1, this.groupBox2, this.groupBox3, this.label12, this.label13, this.label25, this.label37 });
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        this.label12.Text = "JPEG Compression - Quality After Scanning, 0-100. 100=No compression.  Typical se" + "tting: 40.";
        ...
        this.textDoc.setMaxVal(255);
        this.textDoc.setMinVal(0);
    ...
    private void formScannerSetup_Load(Object sender, System.EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textDoc.errorProvider1.GetError(textDoc), ""))
        {
