...
*/
public class FormDunningEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.TextBox textDunMessage = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.GroupBox groupBox2 = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.RadioButton radioY = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioN = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioU = new System.Windows.Forms.RadioButton();
    private TextBox textMessageBold = new TextBox();
    private Label label2 = new Label();
    private GroupBox groupBox3 = new GroupBox();
    private GroupBox groupBox4 = new GroupBox();
    private Label label3 = new Label();
    private TextBox textEmailBody = new TextBox();
    private TextBox textEmailSubject = new TextBox();
    ...
    * 
    */
    public FormDunningEdit(Dunning dunningCur) throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormDunningEdit.class);
    ...
    private void formDunningEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()].Length;i++)
        {
            ...
            if (DunningCur.BillingType == DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()][i].DefNum)
            {
                listBillType.SetSelected(i + 1, true);
            }
             
        }
        System.Byte __dummyScrutVar0 = DunningCur.AgeAccount;
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (StringSupport.equals(textDunMessage.Text, "") && StringSupport.equals(textMessageBold.Text, "") && StringSupport.equals(textEmailSubject.Text, "") && StringSupport.equals(textEmailBody.Text, ""))
        {
        ...
        {
            DunningCur.BillingType = DefC.getShort()[((Enum)DefCat.BillingTypes).ordinal()][listBillType.SelectedIndex - 1].DefNum;
        } 
        if (radioAny.Checked)
        {
