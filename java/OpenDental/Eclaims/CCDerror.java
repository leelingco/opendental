...
public class CCDerror   
{
    ...
    */
    public static String message(int errorCode, boolean useFrench) throws Exception {
        if (useFrench)
        {
    ...
    private static String messageEn4(int errorCode) throws Exception {
        switch(errorCode)
        {
            default: 
                break;
    ...
    private static String messageFr4(int errorCode) throws Exception {
        switch(errorCode)
        {
            default: 
                break;
