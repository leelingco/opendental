...
*/
public class FormEtransEdit  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butCancel;
    private OpenDental.UI.Button butOK;
    private RichTextBox textMessageText = new RichTextBox();
    private Label label1 = new Label();
    /**
    * Required designer variable.
    */
    private System.ComponentModel.Container components = null;
    private TextBox textClaimNum = new TextBox();
    private Label label2 = new Label();
    private Label label3 = new Label();
    private TextBox textBatchNumber = new TextBox();
    private Label label4 = new Label();
    private TextBox textTransSetNum = new TextBox();
    private Label label5 = new Label();
    private TextBox textAckCode = new TextBox();
    private Label label6 = new Label();
    private TextBox textNote = new TextBox();
    private GroupBox groupAck = new GroupBox();
    private Label label7 = new Label();
    private RichTextBox textAckMessage = new RichTextBox();
    private Label label9 = new Label();
    private TextBox textAckDateTime = new TextBox();
    private Label label8 = new Label();
    private TextBox textDateTimeTrans = new TextBox();
    public Etrans EtransCur;
    private OpenDental.UI.Button butPrint;
    private Etrans AckCur;
    private PrintDocument pd2 = new PrintDocument();
    //private bool headingPrinted;
    private CheckBox checkAttachments = new CheckBox();
    ...
    * 
    */
    public FormEtransEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormEtransEdit.class);
        ...
        // butPrintAck
        //
        this.butPrintAck.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        ...
        this.butPrintAck.setAutosize(true);
        this.butPrintAck.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butPrintAck.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butPrintAck.setCornerRadius(4F);
        this.butPrintAck.Image = Resources.getbutPrint();
    ...
    private void formEtransEdit_Load(Object sender, EventArgs e) throws Exception {
        ...
        if (EtransCur.Etype == EtransType.ClaimSent)
        {
            if (X12object.isX12(MessageText))
            {
                ...
                else //This function does not currently work, so the corresponding checkbox is hidden on the form as well.
                if (x12obj.isFormat5010())
                {
        ...
        //This function does not currently work, so the corresponding checkbox is hidden on the form as well.
    ...
    private void pd2_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs e) throws Exception {
        ...
        while (yPos < bounds.Bottom && linesPrinted < textMessageText.Lines.Length)
        {
            ...
            yPos += rect.Height;
            linesPrinted++;
            if (textMessageText.Lines[linesPrinted - 1].EndsWith("\f"))
            {
                break;
            }
    ...
    private void butPrintAck_Click(Object sender, EventArgs e) throws Exception {
        //only visible if Canadian
        new FormCCDPrint(AckCur, textAckMessage.Text, false);
    }

    //Show the form on screen and make the user print manually if they desire to print.
