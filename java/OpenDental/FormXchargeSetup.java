...
*/
public class FormXchargeSetup  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private TextBox textPath = new TextBox();
    ...
    * 
    */
    public FormXchargeSetup() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormXchargeSetup.class);
    ...
    private void formXchargeSetup_Load(Object sender, EventArgs e) throws Exception {
        ...
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.PaymentTypes).ordinal()].Length;i++)
        {
            ...
            if (StringSupport.equals(DefC.getShort()[((Enum)DefCat.PaymentTypes).ordinal()][i].DefNum.ToString(), paymentType))
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        //should never happen
        if (!StringSupport.equals(textOverride.Text, ""))
        {
        ...
        String paymentType = DefC.getShort()[((Enum)DefCat.PaymentTypes).ordinal()][comboPaymentType.SelectedIndex].DefNum.ToString();
