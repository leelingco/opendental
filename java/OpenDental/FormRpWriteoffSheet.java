...
* 
*/
public class FormRpWriteoffSheet  extends System.Windows.Forms.Form 
{
    ...
    * 
    */
    public FormRpWriteoffSheet() throws Exception {
        initializeComponent();
        Lan.f(this);
    }
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormRpWriteoffSheet.class);
    ...
    private void formDailyWriteoff_Load(Object sender, System.EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        {
            report.Query += "SELECT " + DbHelper.dateColumn("claimproc.DateCP") + " date," + DbHelper.concat("patient.LName","', '","patient.FName","' '","patient.MiddleI") + "," + "carrier.CarrierName," + "provider.Abbr,";
            if (!PrefC.getBool(PrefName.EasyNoClinics))
            {
            ...
            //,insplan,patient,carrier,provider "
            /*received or supplemental*/
            report.Query += "claimproc.ClaimNum " + "FROM claimproc " + "LEFT JOIN insplan ON claimproc.PlanNum = insplan.PlanNum " + "LEFT JOIN patient ON claimproc.PatNum = patient.PatNum " + "LEFT JOIN carrier ON carrier.CarrierNum = insplan.CarrierNum " + "LEFT JOIN provider ON provider.ProvNum = claimproc.ProvNum " + "LEFT JOIN clinic ON clinic.ClinicNum=claimproc.ClinicNum " + "WHERE (claimproc.Status=1 OR claimproc.Status=4) " + whereProv + whereClin + "AND claimproc.DateCP >= @FromDate " + "AND claimproc.DateCP <= @ToDate " + "AND claimproc.WriteOff > 0 " + "GROUP BY claimproc.ProvNum,claimproc.DateCP,claimproc.ClinicNum,claimproc.PatNum " + "ORDER BY claimproc.DateCP,claimproc.PatNum";
        }
        else
        {
            //using procedure date
            report.Query += "SELECT " + DbHelper.dateColumn("claimproc.ProcDate") + " date, " + DbHelper.concat("patient.LName","', '","patient.FName","' '","patient.MiddleI") + ", " + "carrier.CarrierName, " + "provider.Abbr,";
            if (!PrefC.getBool(PrefName.EasyNoClinics))
            {
                report.Query += "clinic.Description,";
            }
