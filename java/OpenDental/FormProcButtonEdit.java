...
* 
*/
public class FormProcButtonEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.ListBox listADA = new System.Windows.Forms.ListBox();
    ...
    * 
    */
    public FormProcButtonEdit(ProcButton procButtonCur) throws Exception {
        initializeComponent();
        Lan.f(this);
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormProcButtonEdit.class);
    ...
    private void formChartProcedureEntryEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        {
            comboCategory.Items.Add(DefC.getShort()[((Enum)DefCat.ProcButtonCats).ordinal()][i].ItemName);
            if (ProcButtonCur.Category == DefC.getShort()[((Enum)DefCat.ProcButtonCats).ordinal()][i].DefNum)
            {
        ...
        //we know that there will always be at least one cat. Validated in FormProcButtons
        ...
        {
            listAutoCodes.Items.Add(AutoCodeC.getListShort()[i].Description);
            for (int j = 0;j < auto.Length;j++)
            {
                if (auto[j] == AutoCodeC.getListShort()[i].AutoCodeNum)
                {
    ...
    private void listView_ItemActivate(Object sender, EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (ProcButtonCur.Category != DefC.getShort()[((Enum)DefCat.ProcButtonCats).ordinal()][comboCategory.SelectedIndex].DefNum)
        {
            //This will put it at the end of the order in the new category
            ProcButtonCur.ItemOrder = ProcButtons.GetForCat(DefC.getShort()[((Enum)DefCat.ProcButtonCats).ordinal()][comboCategory.SelectedIndex].DefNum).Length;
        }
         
        ProcButtonCur.Category = DefC.getShort()[((Enum)DefCat.ProcButtonCats).ordinal()][comboCategory.SelectedIndex].DefNum;
        ProcButtonCur.ButtonImage = POut.Bitmap((Bitmap)pictureBox.Image, System.Drawing.Imaging.ImageFormat.Png);
        if (IsNew)
        {
            ProcButtonCur.ItemOrder = ProcButtons.getList().Length;
        ...
        for (int i = 0;i < listAutoCodes.SelectedIndices.Count;i++)
        {
            item = new ProcButtonItem();
            item.ProcButtonNum = ProcButtonCur.ProcButtonNum;
            item.AutoCodeNum = AutoCodeC.getListShort()[listAutoCodes.SelectedIndices[i]].AutoCodeNum;
            ProcButtonItems.insert(item);
        }
