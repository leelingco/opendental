//
// Translated by CS2J (http://www.cs2j.com): 2/15/2016 7:58:45 PM
//
...
* 
*/
public class FormChartView  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private TextBox textBoxViewDesc = new TextBox();
    private GroupBox groupBoxProperties = new GroupBox();
    private OpenDental.UI.Button butDelete;
    private Label labelDescription = new Label();
    private ListBox listProcStatusCodes = new ListBox();
    private Label labelProcStatus = new Label();
    private Label label1 = new Label();
    private ComboBox comboDatesShowing = new ComboBox();
    public ChartView ChartViewCur;
    /**
    * 
    */
    public FormChartView() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormChartView.class);
        ...
        // listAvailable
        //
        this.listAvailable.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left)));
    ...
    private void formChartView_Load(Object sender, EventArgs e) throws Exception {
        String[] chartViewDateTypes = Enum.GetNames(ChartViewDates.class);
        Array chartViewDateValues = Enum.GetValues(ChartViewDates.class);
        ...
        //This will be zero for a new ChartView
        fillGrids();
    }
    ...
    private void checkShowCn_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }
    ...
    private void checkAppt_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }

    private void checkComm_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }

    private void checkCommFamily_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }

    private void checkLabCase_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }
    ...
    private void checkTasks_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }

    private void checkEmail_Click(Object sender, System.EventArgs e) throws Exception {
        changed = true;
    }
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        if (StringSupport.equals(textBoxViewDesc.Text.Trim(), ""))
        {
            MsgBox.show(this,"View description cannot be blank.");
            return ;
        }
         
        if (!StringSupport.equals(ChartViewCur.Description, textBoxViewDesc.Text))
        {
            changed = true;
        }
        ...
        ChartViewCur.DatesShowing = (ChartViewDates)Enum.GetValues(ChartViewDates.class).GetValue(comboDatesShowing.SelectedIndex);
    ...
    private void comboDatesShowing_SelectedIndexChanged(Object sender, EventArgs e) throws Exception {
        changed = true;
    }
