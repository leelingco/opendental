...
*/
public class FormSigElementDefEdit  extends System.Windows.Forms.Form 
{
    ...
    private TextBox textSigText = new TextBox();
    private Label label3 = new Label();
    private Label label5 = new Label();
    private Label label6 = new Label();
    private OpenDental.ValidNum textLightRow;
    ...
    * 
    */
    public FormSigElementDefEdit() throws Exception {
        //
    ...
    */
    ...
    private void formSigElementDefEdit_Load(Object sender, EventArgs e) throws Exception {
        ...
        listType.SelectedIndex = ((Enum)ElementCur.SigElementType).ordinal();
    ...
    private void setSoundButtons() throws Exception {
        if (StringSupport.equals(ElementCur.Sound, ""))
        {
    ...
    private void butPlay_Click(Object sender, EventArgs e) throws Exception {
        try
        {
    ...
    private void butDeleteSound_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void butRecord_Click(Object sender, EventArgs e) throws Exception {
        try
        {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textLightRow.errorProvider1.GetError(textLightRow), ""))
        {
            MsgBox.show(this,"Please fix data entry errors first.");
            return ;
        }
         
        if (StringSupport.equals(textSigText.Text, ""))
        {
