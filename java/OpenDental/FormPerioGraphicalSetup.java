...
public class FormPerioGraphicalSetup  extends Form 
{

    public FormPerioGraphicalSetup() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formPerioGraphicalSetup_Load(Object sender, EventArgs e) throws Exception {
    ...
    */
    ...
    private System.Windows.Forms.ColorDialog colorPicker = new System.Windows.Forms.ColorDialog();
}
