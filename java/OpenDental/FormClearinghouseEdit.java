...
*/
public class FormClearinghouseEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.TextBox textPayors = new System.Windows.Forms.TextBox();
    /**
    * 
    */
    ...
    private System.Windows.Forms.TextBox textISA08 = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.ComboBox comboFormat = new System.Windows.Forms.ComboBox();
    ...
    private System.Windows.Forms.TextBox textResponsePath = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.ComboBox comboCommBridge = new System.Windows.Forms.ComboBox();
    private System.Windows.Forms.TextBox textClientProgram = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label12 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textModemPort = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textLoginID = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label15 = new System.Windows.Forms.Label();
    private GroupBox groupBox1 = new GroupBox();
    private Label label9 = new Label();
    private TextBox textISA05 = new TextBox();
    private Label label16 = new Label();
    private TextBox textSenderTIN = new TextBox();
    private Label label19 = new Label();
    private TextBox textISA07 = new TextBox();
    private Label label20 = new Label();
    private Label label21 = new Label();
    private Label label22 = new Label();
    private TextBox textISA15 = new TextBox();
    ...
    private TextBox textSenderTelephone = new TextBox();
    private TextBox textSenderName = new TextBox();
    private RadioButton radioSenderBelow = new RadioButton();
    private RadioButton radioSenderOD = new RadioButton();
    private Label label17 = new Label();
    private Label label18 = new Label();
    private TextBox textGS03 = new TextBox();
    ...
    * 
    */
    public FormClearinghouseEdit() throws Exception {
        //
        // Required for Windows Form Designer support
        //
        initializeComponent();
        Lan.f(this);
        Lan.C(this, new System.Windows.Forms.Control[]{ this.textBox2 });
    }
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormClearinghouseEdit.class);
        ...
        this.textBox2.Text = "The list of payor IDs should be separated by commas with no spaces or other punct" + "uation.  For instance: 01234,23456 is valid.  You do not have to enter any payor" + " ID\'s for a default Clearinghouse.";
        //
        // label4
        //
    ...
    private void formClearinghouseEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        if (StringSupport.equals(ClearinghouseCur.SenderTIN, ""))
        {
        ...
        for (int i = 0;i < Enum.GetNames(ElectronicClaimFormat.class).Length;i++)
        {
            comboFormat.Items.Add(Enum.GetNames(ElectronicClaimFormat.class)[i]);
        }
        comboFormat.SelectedIndex = ((Enum)ClearinghouseCur.Eformat).ordinal();
        for (int i = 0;i < Enum.GetNames(EclaimsCommBridge.class).Length;i++)
        {
            comboCommBridge.Items.Add(Enum.GetNames(EclaimsCommBridge.class)[i]);
        }
        comboCommBridge.SelectedIndex = ((Enum)ClearinghouseCur.CommBridge).ordinal();
    ...
    private void radio_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (StringSupport.equals(textISA08.Text, "0135WCH00") && !radioSenderOD.Checked)
        {
            MsgBox.show(this,"When using Emdeon, this software must be the sender.");
            return ;
        }
         
        if (comboFormat.SelectedIndex == ((Enum)ElectronicClaimFormat.x837D_4010).ordinal() || comboFormat.SelectedIndex == ((Enum)ElectronicClaimFormat.x837D_5010_dental).ordinal() || comboFormat.SelectedIndex == ((Enum)ElectronicClaimFormat.x837_5010_med_inst).ordinal())
        {
            ...
            if (StringSupport.equals(textISA05.Text, ""))
            {
                MsgBox.show(this,"ISA05 is required.");
                return ;
            }
             
            if (!StringSupport.equals(textISA05.Text, "01") && !StringSupport.equals(textISA05.Text, "14") && !StringSupport.equals(textISA05.Text, "20") && !StringSupport.equals(textISA05.Text, "27") && !StringSupport.equals(textISA05.Text, "28") && !StringSupport.equals(textISA05.Text, "29") && !StringSupport.equals(textISA05.Text, "30") && !StringSupport.equals(textISA05.Text, "33") && !StringSupport.equals(textISA05.Text, "ZZ"))
            {
            ...
            if (radioSenderBelow.Checked)
            {
                ...
                if (StringSupport.equals(textSenderName.Text, ""))
                {
            ...
            if (StringSupport.equals(textISA07.Text, ""))
            {
                MsgBox.show(this,"ISA07 is required.");
                return ;
            }
             
            if (!StringSupport.equals(textISA07.Text, "01") && !StringSupport.equals(textISA07.Text, "14") && !StringSupport.equals(textISA07.Text, "20") && !StringSupport.equals(textISA07.Text, "27") && !StringSupport.equals(textISA07.Text, "28") && !StringSupport.equals(textISA07.Text, "29") && !StringSupport.equals(textISA07.Text, "30") && !StringSupport.equals(textISA07.Text, "33") && !StringSupport.equals(textISA07.Text, "ZZ"))
            {
            ...
            if (!StringSupport.equals(textISA15.Text, "T") && !StringSupport.equals(textISA15.Text, "P"))
            {
            ...
            if (!StringSupport.equals(textSeparatorData.Text, "") && !Regex.IsMatch(textSeparatorData.Text, "^[0-9A-F]{2}$", RegexOptions.IgnoreCase))
            {
                MsgBox.show(this,"Data element separator must be a valid 2 digit hexadecimal number or blank.");
                return ;
            }
             
            if (!StringSupport.equals(textISA16.Text, "") && !Regex.IsMatch(textISA16.Text, "^[0-9A-F]{2}$", RegexOptions.IgnoreCase))
            {
                MsgBox.show(this,"Component element separator must be a valid 2 digit hexadecimal number or blank.");
                return ;
            }
             
            if (!StringSupport.equals(textSeparatorSegment.Text, "") && !Regex.IsMatch(textSeparatorSegment.Text, "^[0-9A-F]{2}$", RegexOptions.IgnoreCase))
            {
        ...
        if (!StringSupport.equals(textExportPath.Text, "") && !Directory.Exists(textExportPath.Text))
        {
        ...
        if (!StringSupport.equals(textResponsePath.Text, "") && !Directory.Exists(textResponsePath.Text))
        {
