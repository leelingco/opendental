...
* 
*/
public class FormRpPrescriptions  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butCancel;
    private OpenDental.UI.Button butOK;
    private System.Windows.Forms.Panel panel1 = new System.Windows.Forms.Panel();
    private System.Windows.Forms.RadioButton radioDrug = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioPatient = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.Label labelInstruct = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textBoxInput = new System.Windows.Forms.TextBox();
    private System.ComponentModel.Container components = null;
    private FormQuery FormQuery2;
    /**
    * 
    */
    public FormRpPrescriptions() throws Exception {
        initializeComponent();
        Lan.f(this);
    }
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormRpPrescriptions.class);
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        */
        ...
        report.Query = "SELECT CONCAT(CONCAT(CONCAT(CONCAT(patient.LName,', '),patient.FName)," + "' '),patient.MiddleI),rxpat.rxdate," + "rxpat.drug,rxpat.sig,rxpat.disp,provider.abbr FROM patient,rxpat,provider " + "WHERE patient.patnum=rxpat.patnum AND provider.provnum=rxpat.provnum ";
        if (radioPatient.Checked == true)
        {
            report.Query += "AND patient.lname like '" + textBoxInput.Text + "%'" + " ORDER BY patient.lname,patient.fname,rxpat.rxdate";
        }
        else
        {
            report.Query += "AND rxpat.drug like '" + textBoxInput.Text + "%'" + " ORDER BY patient.lname,rxpat.drug,rxpat.rxdate";
        } 
