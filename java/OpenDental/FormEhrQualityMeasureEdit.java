...
public class FormEhrQualityMeasureEdit  extends Form 
{
    ...
    public FormEhrQualityMeasureEdit() throws Exception {
        initializeComponent();
    }

    private void formQualityEdit_Load(Object sender, EventArgs e) throws Exception {
        textId.Text = Qcur.Id;
        ...
        textPerformanceRate.Text = Qcur.Numerator.ToString() + "/" + (Qcur.Numerator + Qcur.NotMet).ToString() + "  = " + Qcur.PerformanceRate.ToString() + "%";
    ...
    private void fillGrid() throws Exception {
        ...
        for (int i = 0;i < table.Rows.Count;i++)
        {
            ...
            row.getCells().Add(table.Rows[i]["numerator"].ToString());
            row.getCells().Add(table.Rows[i]["exclusion"].ToString());
            row.getCells().Add(table.Rows[i]["explanation"].ToString());
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormEhrQualityMeasureEdit.class);
        ...
        //
        this.textExclusionsExplain.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
    ...
    private System.Windows.Forms.TextBox textExclusions = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textExclusionsExplain = new System.Windows.Forms.TextBox();
}
