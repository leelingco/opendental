...
*/
public class FormTrojanCollect  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butCancel;
    private OpenDental.UI.Button butOK;
    private OpenDental.UI.Button butHelp;
    private Label label1 = new Label();
    private Label labelGuarantor = new Label();
    private Label labelAddress = new Label();
    private Label labelCityStZip = new Label();
    private Label label4 = new Label();
    private Label label5 = new Label();
    private Label label6 = new Label();
    private Label labelSSN = new Label();
    private Label labelDOB = new Label();
    private Label labelPhone = new Label();
    private Label label10 = new Label();
    private Label labelEmpPhone = new Label();
    private Label labelEmployer = new Label();
    private Label label13 = new Label();
    private Label labelPatient = new Label();
    private Label label15 = new Label();
    private Label label16 = new Label();
    private TextBox textDate = new TextBox();
    private TextBox textAmount = new TextBox();
    private Label label17 = new Label();
    private RadioButton radioDiplomatic = new RadioButton();
    private RadioButton radioFirm = new RadioButton();
    private RadioButton radioSkip = new RadioButton();
    ...
    * 
    */
    public FormTrojanCollect() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormTrojanCollect.class);
        ...
        // butHelp
        //
        this.butHelp.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        ...
        this.butHelp.setAutosize(true);
        this.butHelp.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butHelp.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butHelp.setCornerRadius(4F);
    ...
    private void formTrojanCollect_Load(Object sender, EventArgs e) throws Exception {
        ...
        if (!StringSupport.equals(guarCur.Address2, ""))
        {
        ...
        DateTime lastProcDate = new DateTime();
        if (table.Rows.Count == 0)
        {
            lastProcDate = DateTime.MinValue;
        }
        else
        {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (!StringSupport.equals(textPassword.Text, PrefC.getString(PrefName.TrojanExpressCollectPassword)))
        {
        ...
        if (StringSupport.equals(folderPath, ""))
        {
        ...
        {
            Cursor = Cursors.Default;
            MessageBox.Show("The Trojan Communicator is not installed or is not configured for the folder: " + folderPath + ".  Please contact Trojan Software Support at 800-451-9723 x1 or x2");
            return ;
        }
        ...
        str.Append(clip(guarCur.LName,18) + "*");
        //validated
        str.Append(clip(guarCur.FName,18) + "*");
        //validated
        str.Append(clip(guarCur.MiddleI,1) + "*");
        str.Append(guarCur.SSN.Substring(0, 3) + "-" + guarCur.SSN.Substring(3, 2) + "-" + guarCur.SSN.Substring(5, 4) + "*");
        //validated
        if (guarCur.Birthdate.Year < 1880)
        {
            str.Append("*");
        ...
        String address = guarCur.Address;
        //validated
        if (!StringSupport.equals(guarCur.Address2, ""))
        {
        ...
        str.Append(clip(guarCur.City,20) + "*");
        //validated
        str.Append(clip(guarCur.State,2) + "*");
        //validated
        str.Append(clip(guarCur.Zip,5) + "*");
        //validated
        str.Append(amtDebt.ToString("F2") + "*");
        //validated
        str.Append(dateDelinquency.ToString("MM/dd/yyyy") + "*");
        //validated
        str.Append(textPassword.Text + "*");
        //validated
        str.Append(clip(Security.getCurUser().UserName,25) + "\r\n");
    ...
    /**
    * Clips the input string to the specified length.  Also strips out any *, tabs, newlines, etc.
    */
    private String clip(String inputstr, int length) throws Exception {
    ...
    private void butHelp_Click(Object sender, EventArgs e) throws Exception {
