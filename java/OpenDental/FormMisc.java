...
* 
*/
public class FormMisc  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butOK;
    private OpenDental.UI.Button butCancel;
    private IContainer components = new IContainer();
    private System.Windows.Forms.TextBox textMainWindowTitle = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label3 = new System.Windows.Forms.Label();
    private OpenDental.ValidNumber textSigInterval;
    private OpenDental.UI.Button butLanguages;
    private Label label4 = new Label();
    private ToolTip toolTip1 = new ToolTip();
    private ComboBox comboShowID = new ComboBox();
    private CheckBox checkTaskListAlwaysShow = new CheckBox();
    private CheckBox checkTasksCheckOnStartup = new CheckBox();
    private CheckBox checkBoxTaskKeepListHidden = new CheckBox();
    //private ComputerPref computerPref;
    private OpenDental.ValidNumber validNumX;
    private Label labelX = new Label();
    private GroupBox groupBox2 = new GroupBox();
    private GroupBox groupBoxTaskDefaults = new GroupBox();
    private OpenDental.ValidNumber validNumY;
    private Label labelY = new Label();
    private RadioButton radioRight = new RadioButton();
    private RadioButton radioBottom = new RadioButton();
    private Label label15 = new Label();
    private Label label17 = new Label();
    private GroupBox groupBox6 = new GroupBox();
    private CheckBox checkTitleBarShowSite = new CheckBox();
    private TextBox textWebServiceServerName = new TextBox();
    private Label label2 = new Label();
    private CheckBox checkTasksNewTrackedByUser = new CheckBox();
    private CheckBox checkShowOpenTickets = new CheckBox();
    private Label label1 = new Label();
    //private List<Def> posAdjTypes;
    /**
    * 
    */
    public FormMisc() throws Exception {
        initializeComponent();
        Lan.f(this);
    }
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormMisc.class);
        ...
        this.label3.Text = "Process Signal Interval in seconds.  Usually every 6 to 20 seconds.  Leave blank " + "to disable autorefresh";
        ...
        this.validNumY.setMaxVal(1200);
        this.validNumY.setMinVal(300);
        ...
        this.validNumX.setMaxVal(2000);
        this.validNumX.setMinVal(300);
        ...
        // butLanguages
        //
        this.butLanguages.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butLanguages.setAutosize(true);
        this.butLanguages.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butLanguages.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butLanguages.setCornerRadius(4F);
        ...
        this.textSigInterval.setMaxVal(1000000);
        this.textSigInterval.setMinVal(1);
    ...
    private void formMisc_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        checkBoxTaskKeepListHidden.Checked = ComputerPrefs.getLocalComputer().TaskKeepListHidden;
        ...
        validNumX.Text = ComputerPrefs.getLocalComputer().TaskX.ToString();
        validNumY.Text = ComputerPrefs.getLocalComputer().TaskY.ToString();
    ...
    private void butLanguages_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void checkTaskListAlwaysShow_CheckedChanged(Object sender, EventArgs e) throws Exception {
        if (checkTaskListAlwaysShow.Checked)
        {
            groupBoxTaskDefaults.Enabled = true;
        }
    ...
    private void checkBoxTaskKeepListHidden_CheckedChanged(Object sender, EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(validNumX.errorProvider1.GetError(validNumX), "") | !StringSupport.equals(validNumY.errorProvider1.GetError(validNumY), ""))
        {
        ...
        if (Prefs.UpdateString(PrefName.MainWindowTitle, textMainWindowTitle.Text) | Prefs.UpdateLong(PrefName.ShowIDinTitleBar, comboShowID.SelectedIndex) | Prefs.UpdateBool(PrefName.TaskListAlwaysShowsAtBottom, checkTaskListAlwaysShow.Checked) | Prefs.UpdateBool(PrefName.TasksCheckOnStartup, checkTasksCheckOnStartup.Checked) | Prefs.UpdateBool(PrefName.TasksNewTrackedByUser, checkTasksNewTrackedByUser.Checked) | Prefs.UpdateBool(PrefName.TasksShowOpenTickets, checkShowOpenTickets.Checked) | Prefs.UpdateBool(PrefName.TitleBarShowSite, checkTitleBarShowSite.Checked) | Prefs.UpdateString(PrefName.WebServiceServerName, textWebServiceServerName.Text))
        {
            changed = true;
        }
         
        //task list------------------------------------------------------------------------------------------
        if (ComputerPrefs.getLocalComputer().TaskKeepListHidden != checkBoxTaskKeepListHidden.Checked)
        {
            ComputerPrefs.getLocalComputer().TaskKeepListHidden = checkBoxTaskKeepListHidden.Checked;
            changed = true;
        }
         
        //needed to trigger screen refresh
        if (radioBottom.Checked && ComputerPrefs.getLocalComputer().TaskDock != 0)
        {
            ComputerPrefs.getLocalComputer().TaskDock = 0;
            changed = true;
        }
        else if (!radioBottom.Checked && ComputerPrefs.getLocalComputer().TaskDock != 1)
        {
            ComputerPrefs.getLocalComputer().TaskDock = 1;
            changed = true;
        }
          
        if (ComputerPrefs.getLocalComputer().TaskX != PIn.Int(validNumX.Text))
        {
            ComputerPrefs.getLocalComputer().TaskX = PIn.Int(validNumX.Text);
            changed = true;
        }
         
        if (ComputerPrefs.getLocalComputer().TaskY != PIn.Int(validNumY.Text))
        {
            ComputerPrefs.getLocalComputer().TaskY = PIn.Int(validNumY.Text);
            changed = true;
        }
         
        //end of tasklist section-----------------------------------------------------------------------------
        if (StringSupport.equals(textSigInterval.Text, ""))
        {
