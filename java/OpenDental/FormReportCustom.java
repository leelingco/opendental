...
* 
*/
public class FormReportCustom  extends System.Windows.Forms.Form 
{
    ...
    * 
    */
    public FormReportCustom() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormReportCustom.class);
        ...
        this.viewer.setParameters("XPat=" + FormOpenDental.CurPatNum.ToString());
    ...
    private void formRDLreport_Load(Object sender, System.EventArgs e) throws Exception {
        layoutToolBar();
        viewer.setShowParameterPanel(true);
        viewer.rebuild();
    }
    ...
    */
    public void layoutToolBar() throws Exception {
        ...
        ToolBarMain.getButtons().add(new OpenDental.UI.ODToolBarButton(Lan.g(this,"Save PDF"), 4, "Save as Adobe PDF", "PDF"));
