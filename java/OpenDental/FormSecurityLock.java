...
*/
public class FormSecurityLock  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butCancel;
    private OpenDental.UI.Button butOK;
    private Label label1 = new Label();
    private CheckBox checkAdmin = new CheckBox();
    ...
    * 
    */
    public FormSecurityLock() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormSecurityLock.class);
    ...
    private void formSecurityLock_Load(Object sender, EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (Prefs.UpdateString(PrefName.SecurityLockDate, POut.Date(date, false)) | Prefs.updateInt(PrefName.SecurityLockDays,days) | Prefs.UpdateBool(PrefName.SecurityLockIncludesAdmin, checkAdmin.Checked))
        {
