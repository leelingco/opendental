...
public class FormSupplyOrderItemEdit  extends Form 
{

    private Supply Supp;
    public SupplyOrderItem ItemCur;
    public List<Supplier> ListSupplier = new List<Supplier>();
    public FormSupplyOrderItemEdit() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formSupplyOrderItemEdit_Load(Object sender, EventArgs e) throws Exception {
    ...
    private void textPrice_TextChanged(Object sender, EventArgs e) throws Exception {
        fillSubtotal();
    }
    ...
    private void fillSubtotal() throws Exception {
        ValidateChildren();
        //allows errorProvider1 to populate error message text.
        if (!StringSupport.equals(textQty.errorProvider1.GetError(textQty), "") || !StringSupport.equals(textPrice.errorProvider1.GetError(textPrice), ""))
        {
            return ;
        }
         
        if (StringSupport.equals(textQty.Text, "") || StringSupport.equals(textPrice.Text, ""))
        {
            return ;
        }
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        this.textQty.setMaxVal(10000);
        this.textQty.setMinVal(0);
    ...
    private OpenDental.ValidNumber textQty;
    private System.Windows.Forms.TextBox textCategory = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label4 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textSubtotal = new System.Windows.Forms.TextBox();
}
