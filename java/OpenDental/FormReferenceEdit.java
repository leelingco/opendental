...
public class FormReferenceEdit  extends Form 
{

    private CustReference RefCur;
    private List<CustRefEntry> RefEntryList = new List<CustRefEntry>();
    public FormReferenceEdit(CustReference refCur) throws Exception {
        initializeComponent();
        Lan.F(this);
        RefCur = refCur;
    }
    ...
    private void fillMain() throws Exception {
        ...
        for (int i = 0;i < RefEntryList.Count;i++)
        {
            ...
            row.getCells().Add(pat.PatNum.ToString());
            row.getCells().add(pat.LName);
            row.getCells().add(pat.FName);
            row.getCells().Add(RefEntryList[i].DateEntry.ToShortDateString());
    ...
    private void gridMain_CellDoubleClick(Object sender, OpenDental.UI.ODGridClickEventArgs e) throws Exception {
        FormReferenceEntryEdit FormREE = new FormReferenceEntryEdit(RefEntryList[e.getRow()]);
        FormREE.ShowDialog();
        fillMain();
    }
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        if (!StringSupport.equals(textRecentDate.errorProvider1.GetError(textRecentDate), ""))
        {
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        this.gridMain.setTitle("Used as a Reference for These New Customers");
    ...
    private System.Windows.Forms.CheckBox checkBadRef = new System.Windows.Forms.CheckBox();
    ...
    private OpenDental.ValidDate textRecentDate;
