...
*/
public class FormWarnToCloseComputers  extends Form 
{

    public FormWarnToCloseComputers() throws Exception {
        initializeComponent();
    }

    private void formWarnToCloseComputers_Load(Object sender, EventArgs e) throws Exception {
        Image[] _Images = new Image[8];
        System.Reflection.Assembly thisExe = new System.Reflection.Assembly();
        thisExe = System.Reflection.Assembly.GetExecutingAssembly();
        String[] resources = thisExe.GetManifestResourceNames();
        String baseName = "SnuffLight";
        List<String> list_resources = new List<String>();
        for (Object __dummyForeachVar0 : resources)
        {
        ...
        for (int i = 1;i < 9;i++)
        {
            ...
            for (int j = 1;j < list_resources.Count;j++)
            {
                ...
                {
                    System.IO.Stream file = thisExe.GetManifestResourceStream(list_resources[j]);
        ...
        this.imageAnimator1.setSET_IMAGES(_Images);
        this.imageAnimator1.startAnimation();
    }

    private void butYes_Click(Object sender, EventArgs e) throws Exception {
        this.DialogResult = DialogResult.Yes;
    }

    private void butNoCancel_Click(Object sender, EventArgs e) throws Exception {
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormWarnToCloseComputers.class);
        ...
        this.imageAnimator1.setSET_IMAGES(null);
    ...
    private System.Windows.Forms.Button butYes = new System.Windows.Forms.Button();
    private System.Windows.Forms.Button butNoCancel = new System.Windows.Forms.Button();
