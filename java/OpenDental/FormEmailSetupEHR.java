...
public class FormEmailSetupEHR  extends Form 
{

    public FormEmailSetupEHR() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formEmailSetupEHR_Load(Object sender, EventArgs e) throws Exception {
    ...
    */
    ...
    private System.Windows.Forms.TextBox textPort = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textPOPserver = new System.Windows.Forms.TextBox();
