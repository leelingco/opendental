...
public class FormEhrProvKeyEditCust  extends Form 
{

    public EhrProvKey KeyCur;
    public FormEhrProvKeyEditCust() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formEhrProvKeyEditCust_Load(Object sender, EventArgs e) throws Exception {
    ...
    private void butGenerate_Click(Object sender, EventArgs e) throws Exception {
        if (StringSupport.equals(textLName.Text, "") || StringSupport.equals(textFName.Text, ""))
        {
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        ...
        if (!StringSupport.equals(textEhrKey.Text, ""))
        {
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormEhrProvKeyEditCust.class);
    ...
    private System.Windows.Forms.TextBox textFullTimeEquiv = new System.Windows.Forms.TextBox();
