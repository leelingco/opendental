...
import OpenDental.FormToothGridDefEdit;
...
* 
*/
public class FormToothGridDefEdit  extends System.Windows.Forms.Form 
{
    private OpenDental.UI.Button butCancel;
    private OpenDental.UI.Button butOK;
    private Label label1 = new Label();
    private TextBox textInternalName = new TextBox();
    private TextBox textNameShowing = new TextBox();
    ...
    */
    ...
    private TextBox textCodeNum = new TextBox();
    private Label label5 = new Label();
    private Label label6 = new Label();
    private ListBox listCellType = new ListBox();
    private ListBox listProcStatus = new ListBox();
    private Font headerFont = new Font(FontFamily.GenericSansSerif, 8.5f, FontStyle.Bold);
    /**
    * 
    */
    public FormToothGridDefEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormToothGridDefEdit.class);
    ...
    private void fillListCellType() throws Exception {
        for (Object __dummyForeachVar0 : Enum.GetNames(ToothGridCellType.class))
        {
            String type = (String)__dummyForeachVar0;
            listCellType.Items.Add(type);
        }
    }

    private void fillListProcStatus() throws Exception {
        for (Object __dummyForeachVar1 : Enum.GetNames(ProcStat.class))
        {
            String type = (String)__dummyForeachVar1;
