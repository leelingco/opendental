...
import OpenDental.NewCrop.PrescriberNetwork;
import OpenDental.NewCrop.PrescriberStatus;
...
public class LicensedPrescriberType   
{
    ...
    private String freeformCredentialsField = new String();
    ...
    * 
    */
    public String getfreeformCredentials() throws Exception {
        return this.freeformCredentialsField;
    }

    public void setfreeformCredentials(String value) throws Exception {
