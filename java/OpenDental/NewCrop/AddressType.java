...
public class AddressType   
{
    ...
    private String zip4Field = new String();
    private String countryField = new String();
    /**
    * 
    */
    ...
    * 
    */
    public String getzip4() throws Exception {
        return this.zip4Field;
    }

    public void setzip4(String value) throws Exception {
