...
public class ExternalDrugOverride   
{
    ...
    private String externalDrugScheduleField = new String();
    private String externalDrugOverTheCounterField = new String();
    /**
    * 
    */
    ...
    * 
    */
    public String getexternalDrugSchedule() throws Exception {
        return this.externalDrugScheduleField;
    }

    public void setexternalDrugSchedule(String value) throws Exception {
    ...
    * 
    */
    public String getexternalDrugOverTheCounter() throws Exception {
        return this.externalDrugOverTheCounterField;
    }

    public void setexternalDrugOverTheCounter(String value) throws Exception {
