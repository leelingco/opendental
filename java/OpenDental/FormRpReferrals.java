...
* 
*/
public class FormRpReferrals  extends System.Windows.Forms.Form 
{
    ...
    private System.Windows.Forms.TabControl tabReferrals = new System.Windows.Forms.TabControl();
    ...
    private String[] AfieldsSelected = new String[]();
    private ArrayList ALrefSelect = new ArrayList();
    ...
    private ArrayList ALrefFilter = new ArrayList();
    /**
    * 
    */
    public FormRpReferrals() throws Exception {
        initializeComponent();
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormRpReferrals.class);
    ...
    private void fillALrefSelect() throws Exception {
    ...
    private void fillALrefFilter() throws Exception {
        //FillALrefFilter
    ...
    private void fillSelectList() throws Exception {
    ...
    private void fillDropListFilter() throws Exception {
    ...
    private void listSelect_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
        createSQLfrom();
    }
    ...
    private void dropListFilter_SelectedIndexChanged(Object sender, System.EventArgs e) throws Exception {
        ...
        if (__dummyScrutVar0.equals("Address") || __dummyScrutVar0.equals("Address2") || __dummyScrutVar0.equals("City") || __dummyScrutVar0.equals("EMail") || __dummyScrutVar0.equals("FName") || __dummyScrutVar0.equals("LName") || __dummyScrutVar0.equals("MName") || __dummyScrutVar0.equals("Note") || __dummyScrutVar0.equals("Phone2") || __dummyScrutVar0.equals("ReferralNum") || __dummyScrutVar0.equals("ST") || __dummyScrutVar0.equals("SSN") || __dummyScrutVar0.equals("Telephone") || __dummyScrutVar0.equals("Title") || __dummyScrutVar0.equals("Zip"))
        {
            textBox.Clear();
        ...
        else if (__dummyScrutVar0.equals("Specialty"))
        {
            ...
            for (Object __dummyForeachVar0 : Enum.GetNames(DentalSpecialty.class))
            {
                String s = (String)__dummyForeachVar0;
                comboBox.Items.Add(s);
            }
        }
        else if (__dummyScrutVar0.equals("UsingTIN") || __dummyScrutVar0.equals("IsHidden") || __dummyScrutVar0.equals("NotPerson"))
        {
            setListBoxConditions();
            comboBox.Items.Clear();
    ...
    private void butAddFilter_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        if (isDropDown)
        {
            if (StringSupport.equals(DropListFilter.SelectedItem.ToString(), "Specialty"))
            {
                sItem = "";
                for (int i = 0;i < comboBox.SelectedIndices.Count;i++)
                {
                    ...
                    sItem += "Specialty " + ListConditions.SelectedItem.ToString() + " '" + comboBox.SelectedIndices[i].ToString() + "'";
