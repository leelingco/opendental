...
public class FormSheetFieldSigBox  extends Form 
{
    ...
    */
    ...
    public FormSheetFieldSigBox() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formSheetFieldSigBox_Load(Object sender, EventArgs e) throws Exception {
        if (IsReadOnly)
        {
            butOK.Enabled = false;
