...
public class FormCpts  extends Form 
{

    public boolean IsSelectionMode = new boolean();
    public Cpt SelectedCpt;
    private List<Cpt> listCpts = new List<Cpt>();
    private boolean changed = new boolean();
    public FormCpts() throws Exception {
        initializeComponent();
        Lan.F(this);
    }
    ...
    private void fillGrid() throws Exception {
        ...
        for (int i = 0;i < listCpts.Count;i++)
        {
            ...
            row.getCells().Add(listCpts[i].CptCode);
            row.getCells().Add(listCpts[i].Description);
            //row.Cells.Add(EhrCodes.GetMeasureIdsForCode(listCpts[i].SnomedCode,"SNOMEDCT"));
            row.setTag(listCpts[i]);
                ;
            //listAll.Add(row);
    ...
    */
    ...
    private void gridMain_CellDoubleClick(Object sender, OpenDental.UI.ODGridClickEventArgs e) throws Exception {
        if (IsSelectionMode)
        {
            SelectedCpt = (Cpt)gridMain.getRows().get___idx(e.getRow()).getTag();
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        ...
        SelectedCpt = (Cpt)gridMain.getRows().get___idx(gridMain.getSelectedIndex()).getTag();
        DialogResult = DialogResult.OK;
    }
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormCpts.class);
        ...
        this.gridMain.setTitle("CPT Codes");
        this.gridMain.setTranslationName("FormCptCodes");
