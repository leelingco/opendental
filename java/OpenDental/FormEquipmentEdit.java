...
public class FormEquipmentEdit  extends Form 
{

    public Equipment Equip;
    public boolean IsNew = new boolean();
    public FormEquipmentEdit() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formEquipmentEdit_Load(Object sender, EventArgs e) throws Exception {
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        if (!StringSupport.equals(textDatePurchased.errorProvider1.GetError(textDatePurchased), "") || !StringSupport.equals(textDateSold.errorProvider1.GetError(textDateSold), "") || !StringSupport.equals(textPurchaseCost.errorProvider1.GetError(textPurchaseCost), "") || !StringSupport.equals(textMarketValue.errorProvider1.GetError(textMarketValue), ""))
        {
        ...
        if (StringSupport.equals(textDatePurchased.Text, ""))
        {
    ...
    */
    ...
    private System.Windows.Forms.TextBox textSerialNumber = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label2 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textModelYear = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label3 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label5 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label6 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textLocation = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label7 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label4 = new System.Windows.Forms.Label();
    private System.Windows.Forms.Label label8 = new System.Windows.Forms.Label();
    private OpenDental.ValidDouble textPurchaseCost;
    private OpenDental.ValidDate textDatePurchased;
    private OpenDental.ValidDate textDateSold;
    private OpenDental.ValidDouble textMarketValue;
    private System.Windows.Forms.TextBox textDateEntry = new System.Windows.Forms.TextBox();
