...
*/
public class FormTerminalOld  extends System.Windows.Forms.Form 
{
    ...
    private TextBox textWkPhone = new TextBox();
    private TextBox textSSN = new TextBox();
    private TextBox textPreferred = new TextBox();
    private TextBox textMiddleI = new TextBox();
    private TextBox textFName = new TextBox();
    private TextBox textLName = new TextBox();
    private Label label7 = new Label();
    private OpenDental.ODtextBox textAddrNotes;
    private GroupBox groupBox1 = new GroupBox();
    private TextBox textHmPhone = new TextBox();
    private TextBox textZip = new TextBox();
    private TextBox textBox1 = new TextBox();
    private CheckBox checkSame = new CheckBox();
    private TextBox textState = new TextBox();
    private Label labelST = new Label();
    private TextBox textAddress = new TextBox();
    private Label label12 = new Label();
    private Label labelCity = new Label();
    private TextBox textAddress2 = new TextBox();
    ...
    private Label labelSSN = new Label();
    ...
    private CheckBox checkInsYes = new CheckBox();
    private Label labelAddrNotes = new Label();
    private Timer timer1 = new Timer();
    private TextBox textWelcome = new TextBox();
    private IContainer components = new IContainer();
    //private bool IsChangingTab;
    private TerminalStatusEnum TerminalStatus = TerminalStatusEnum.Standby;
    private TextBox textReferral = new TextBox();
    private Label labelReferral = new Label();
    private GroupBox groupBox2 = new GroupBox();
    private TextBox textSchool = new TextBox();
    private Label label30 = new Label();
    private Patient PatCur;
    private ComboBox comboPosition = new ComboBox();
    private ComboBox comboGender = new ComboBox();
    private Label label1 = new Label();
    private ComboBox comboStudentStatus = new ComboBox();
    private Label labelConnection = new Label();
    private CheckedListBox listDiseases = new CheckedListBox();
    private Family FamCur;
    private Label label6 = new Label();
    private OpenDental.UI.ContrMultInput multInput;
    private Label labelIns = new Label();
    private CheckBox checkInsNo = new CheckBox();
    private QuestionDef[] QuestionDefList = new QuestionDef[]();
    /**
    * 
    */
    public FormTerminalOld() throws Exception {
        //
    ...
    */
    ...
    /**
    * Occurs every 4 seconds. Checks database for status changes.
    */
    private void timer1_Tick(Object sender, EventArgs e) throws Exception {
        ...
        if (terminal.TerminalStatus == TerminalStatus && PatCur != null && terminal.PatNum == PatCur.PatNum)
        {
            return ;
        }
        ...
        if (TerminalStatus == TerminalStatusEnum.Standby)
        {
            //force move to standby (rare)
    ...
    */
    ...
    /**
    * Fills the first tab page with info.
    */
    private void fillPatientInfo() throws Exception {
        ...
        System.String __dummyScrutVar2 = PatCur.StudentStatus;
        //non
        if (__dummyScrutVar2.equals("N") || __dummyScrutVar2.equals(""))
        {
        ...
        {
            //fulltime
            comboStudentStatus.SelectedIndex = 2;
        }
           
        textSchool.Text = PatCur.SchoolName;
        textReferral.Text = "";
        textAddrNotes.Text = "";
        //because only used for new patients, and we never want patient to see old note.
        textMiddleI.Select();
    }

    //because the first and last names are probably already entered correctly
    private void fillDiseases() throws Exception {
        ...
        {
            listDiseases.Items.Add(DiseaseDefs.getList()[i].DiseaseName);
        }
    }

    private void fillQuestions() throws Exception {
    ...
    private void checkInsYes_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void checkInsNo_Click(Object sender, EventArgs e) throws Exception {
    ...
    /**
    * Throws an exception if error on the page.
    */
    private void savePtInfo() throws Exception {
        ...
        if (StringSupport.equals(textBirthdate.Text, ""))
        {
            throw new ApplicationException(Lan.g(this,"Birthdate must be entered."));
        }
         
        if (TerminalStatus != TerminalStatusEnum.UpdateOnly && StringSupport.equals(textReferral.Text, ""))
        {
        ...
        SelectedIndex __dummyScrutVar3 = comboGender.SelectedIndex;
        ...
        SelectedIndex __dummyScrutVar4 = comboPosition.SelectedIndex;
        ...
        SelectedIndex __dummyScrutVar5 = comboStudentStatus.SelectedIndex;
        ...
        if (TerminalStatus != TerminalStatusEnum.UpdateOnly)
        {
            ...
            if (!StringSupport.equals(textAddrNotes.Text, ""))
            {
    ...
    private void saveDiseases() throws Exception {
        Disease disease;
        for (int i = 0;i < listDiseases.CheckedIndices.Count;i++)
        {
            disease = new Disease();
            disease.PatNum = PatCur.PatNum;
            disease.DiseaseDefNum = DiseaseDefs.getList()[listDiseases.CheckedIndices[i]].DiseaseDefNum;
