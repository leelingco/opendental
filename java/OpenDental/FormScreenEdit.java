...
*/
public class FormScreenEdit  extends System.Windows.Forms.Form 
{
    /**
    ...
    */
    ...
    private System.Windows.Forms.ListBox listUrgency = new System.Windows.Forms.ListBox();
    private System.Windows.Forms.CheckBox checkNeedsSealants = new System.Windows.Forms.CheckBox();
    private OpenDental.UI.Button butOK;
    private System.Windows.Forms.RadioButton radioM = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioF = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.RadioButton radioUnknown = new System.Windows.Forms.RadioButton();
    private System.Windows.Forms.Label label5 = new System.Windows.Forms.Label();
    private System.Windows.Forms.CheckBox checkHasCaries = new System.Windows.Forms.CheckBox();
    private System.Windows.Forms.CheckBox checkExistingSealants = new System.Windows.Forms.CheckBox();
    private System.Windows.Forms.CheckBox checkCariesExperience = new System.Windows.Forms.CheckBox();
    private System.Windows.Forms.CheckBox checkEarlyChildCaries = new System.Windows.Forms.CheckBox();
    private System.Windows.Forms.CheckBox checkMissingAllTeeth = new System.Windows.Forms.CheckBox();
    ...
    private System.Windows.Forms.DomainUpDown updownAgeArrows = new System.Windows.Forms.DomainUpDown();
    private System.Windows.Forms.Label label1 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textScreenGroupOrder = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.ListBox listRace = new System.Windows.Forms.ListBox();
    ...
    * 
    */
    public FormScreenEdit() throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormScreenEdit.class);
    ...
    private void formScreenEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        listRace.Items.AddRange(Enum.GetNames(PatientRaceOld.class));
        listRace.SelectedIndex = ((Enum)ScreenCur.Race).ordinal();
        comboGradeLevel.Items.AddRange(Enum.GetNames(PatientGrade.class));
        comboGradeLevel.SelectedIndex = ((Enum)ScreenCur.GradeLevel).ordinal();
        ArrayList items = new ArrayList();
        if (ScreenCur.Age == 0)
            textAge.Text = "";
        else
            textAge.Text = ScreenCur.Age.ToString(); 
        listUrgency.Items.AddRange(Enum.GetNames(TreatmentUrgency.class));
        listUrgency.SelectedIndex = ((Enum)ScreenCur.Urgency).ordinal();
    ...
    private void setCheckState(CheckBox checkBox, YN state) throws Exception {
        switch(state)
        {
            case Unknown: 
    ...
    private void textScreenGroupOrder_Validating(Object sender, System.ComponentModel.CancelEventArgs e) throws Exception {
        try
        {
    ...
    private void textAge_Validating(Object sender, System.ComponentModel.CancelEventArgs e) throws Exception {
        if (StringSupport.equals(textAge.Text, ""))
            return ;
         
        if (StringSupport.equals(textAge.Text, "0"))
        {
            textAge.Text = "";
            return ;
        }
    ...
    private void updownAgeArrows_MouseDown(Object sender, System.Windows.Forms.MouseEventArgs e) throws Exception {
        ...
        else
        {
            ...
            if (StringSupport.equals(textAge.Text, "1"))
            {
                textAge.Text = "";
                return ;
            }
    ...
    private void textBirthdate_Validating(Object sender, System.ComponentModel.CancelEventArgs e) throws Exception {
    ...
    /**
    * Used by all 6 checkboxes to customize order of 3-state checking.
    */
    private void checkBox_Click(Object sender, System.EventArgs e) throws Exception {
        CheckState __dummyScrutVar2 = ((CheckBox)sender).CheckState;
        if (__dummyScrutVar2.equals(CheckState.Indeterminate))
        {
            ((CheckBox)sender).CheckState = CheckState.Checked;
        }
        else if (__dummyScrutVar2.equals(CheckState.Checked))
        {
            ((CheckBox)sender).CheckState = CheckState.Unchecked;
        }
        else if (__dummyScrutVar2.equals(CheckState.Unchecked))
        {
    ...
    private YN getCheckState(CheckBox checkBox) throws Exception {
        CheckState __dummyScrutVar3 = checkBox.CheckState;
        if (__dummyScrutVar3.equals(CheckState.Indeterminate))
        {
            return YN.Unknown;
        }
        else if (__dummyScrutVar3.equals(CheckState.Checked))
        {
            return YN.Yes;
        }
        else if (__dummyScrutVar3.equals(CheckState.Unchecked))
        {
            return YN.No;
        }
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        ...
        ScreenCur.Birthdate = PIn.Date(textBirthdate.Text);
        //"" is OK
