...
public class FormAutoNotePromptMultiResp  extends Form 
{
    ...
    */
    ...
    public FormAutoNotePromptMultiResp() throws Exception {
        initializeComponent();
        Lan.F(this);
    }

    private void formAutoNotePromptMultiResp_Load(Object sender, EventArgs e) throws Exception {
    ...
    */
    ...
    private System.Windows.Forms.CheckedListBox listMain = new System.Windows.Forms.CheckedListBox();
}
