...
// Laser Labels:// Patient,Insurance Company,Custom,Birthday//// By Bill MacWilliams     Kapricorn Systems Inc.////// Code is broken up into Common section and a section for each Tab//// Some code is copied from other sections of OpenDental//// Report was designed in response to Client requests for more types of sheet labels// with more selection choices.//// Last modification Date: 12/29/2007//
public class FormRpLaserLabels  extends System.Windows.Forms.Form 
{

    private DataTable AddrTable = new DataTable();
    private DataTable RptAddrTable = new DataTable();
    private int pagesPrinted = new int();
    private int labelsPrinted = new int();
    private int insRange = new int();
    private int idxCus = new int();
    private String[] colName = new String[20];
    private OpenDental.UI.FormPrintPreview printPreview;
    private PrintDocument pd = new PrintDocument();
    private OpenDental.UI.Button butOK;
    private TabPage tabCustomLabels = new TabPage();
    private TabPage tabInsCo = new TabPage();
    private TabPage tabPage1 = new TabPage();
    private ListBox listProviders = new ListBox();
    private CheckBox checkAllProviders = new CheckBox();
    private CheckBox checkActiveOnly = new CheckBox();
    private CheckBox checkGroupByFamily = new CheckBox();
    private TextBox textEndName = new TextBox();
    private TextBox textStartName = new TextBox();
    private Label labAllProviders = new Label();
    private Label labOnlyActive = new Label();
    private Label labGroupByFamily = new Label();
    private Label labEndName = new Label();
    private Label labStartName = new Label();
    private TabControl tabLabelSetup = new TabControl();
    private Label labLabelStart = new Label();
    private Label labEndingName = new Label();
    private RadioButton radioButRange = new RadioButton();
    private RadioButton radioButSingle = new RadioButton();
    private TextBox textInsCoStart = new TextBox();
    private Label labInsCoEnd = new Label();
    private TextBox textInsCoEnd = new TextBox();
    private Label labInsCoStart = new Label();
    private Label labInsCoSingle = new Label();
    private NumericUpDown numericInsCoSingle = new NumericUpDown();
    private OpenDental.UI.Button butEndName;
    private OpenDental.UI.Button butStartName;
    private ListBox listInsCo = new ListBox();
    private OpenDental.UI.Button butCancel;
    private Label labZip = new Label();
    private Label labState = new Label();
    private Label labCity = new Label();
    private Label labCustAddr2 = new Label();
    private Label labCustAddr1 = new Label();
    private Label labCustName = new Label();
    private Label labLabelCount = new Label();
    private TextBox textCusZip = new TextBox();
    private TextBox textCusState = new TextBox();
    private TextBox textCusCity = new TextBox();
    private TextBox textCusAddr2 = new TextBox();
    private TextBox textCusAddr1 = new TextBox();
    private TextBox textCusName = new TextBox();
    private NumericUpDown numericCusCount = new NumericUpDown();
    private ListBox listCusNames = new ListBox();
    ...
    private ListBox listStatus = new ListBox();
    private Panel panLabels = new Panel();
    private OpenDental.UI.Button butCusRemove;
    private Label labInsCoStartAddr = new Label();
    private Label labInsCoEndAddr = new Label();
    private OpenDental.UI.Button butInsCoEnd;
    private TabPage tabBirthday = new TabPage();
    private Label labBirthdayTo = new Label();
    private Label labBirthdayFrom = new Label();
    private CheckBox checkBirthdayActive = new CheckBox();
    private TextBox textBirthdayFrom = new TextBox();
    private TextBox textBirthdayTo = new TextBox();
    ...
    public FormRpLaserLabels() throws Exception {
        initializeComponent();
        Lan.f(this);
    }

    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormRpLaserLabels.class);
        ...
        // butCusRemove
        //
        this.butCusRemove.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butCusRemove.setAutosize(true);
        this.butCusRemove.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butCusRemove.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butCusRemove.setCornerRadius(4F);
        ...
        // butCusAdd
        //
        this.butCusAdd.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butCusAdd.setAutosize(true);
        this.butCusAdd.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butCusAdd.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butCusAdd.setCornerRadius(4F);
        ...
        this.numericCusCount.Minimum = new double(new int[]{ 1, 0, 0, 0 });
        ...
        this.numericCusCount.Value = new double(new int[]{ 1, 0, 0, 0 });
        //
        // textCusZip
        //
        ...
        // butInsCoEnd
        //
        this.butInsCoEnd.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butInsCoEnd.setAutosize(true);
        this.butInsCoEnd.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butInsCoEnd.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butInsCoEnd.setCornerRadius(4F);
        ...
        // butInsCoStart
        //
        this.butInsCoStart.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butInsCoStart.setAutosize(true);
        this.butInsCoStart.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butInsCoStart.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butInsCoStart.setCornerRadius(4F);
        ...
        this.numericInsCoSingle.Maximum = new double(new int[]{ 90, 0, 0, 0 });
        this.numericInsCoSingle.Minimum = new double(new int[]{ 1, 0, 0, 0 });
        ...
        this.numericInsCoSingle.Value = new double(new int[]{ 1, 0, 0, 0 });
        //
        // labInsCoEnd
        //
        ...
        // butEndName
        //
        this.butEndName.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butEndName.setAutosize(true);
        this.butEndName.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butEndName.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butEndName.setCornerRadius(4F);
        ...
        // butStartName
        //
        this.butStartName.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butStartName.setAutosize(true);
        this.butStartName.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butStartName.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butStartName.setCornerRadius(4F);
        ...
        // butBirthdayMonth
        //
        this.butBirthdayMonth.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butBirthdayMonth.setAutosize(true);
        this.butBirthdayMonth.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butBirthdayMonth.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butBirthdayMonth.setCornerRadius(4F);
        ...
        // butBirthdayRight
        //
        this.butBirthdayRight.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butBirthdayRight.setAutosize(true);
        this.butBirthdayRight.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butBirthdayRight.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butBirthdayRight.setCornerRadius(4F);
        this.butBirthdayRight.Image = Resources.getRight();
        ...
        // butBirthdayLeft
        //
        this.butBirthdayLeft.setAdjustImageLocation(new System.Drawing.Point(0, 0));
        this.butBirthdayLeft.setAutosize(false);
        this.butBirthdayLeft.setBtnShape(OpenDental.UI.enumType.BtnShape.Rectangle);
        this.butBirthdayLeft.setBtnStyle(OpenDental.UI.enumType.XPStyle.Silver);
        this.butBirthdayLeft.setCornerRadius(4F);
        this.butBirthdayLeft.Image = Resources.getLeft();
    ...
    //
    private void formLaserLabels_Load(Object sender, System.EventArgs e) throws Exception {
        for (int i = 0;i < ProviderC.getListShort().Count;i++)
        {
            listProviders.Items.Add(ProviderC.getListShort()[i].GetLongDesc());
        }
    ...
    private void butOK_Click(Object sender, EventArgs e) throws Exception {
        String patStat = new String();
        String command = new String();
        SelectedIndex __dummyScrutVar0 = tabLabelSetup.SelectedIndex;
        //
        ...
        if (__dummyScrutVar0.equals(0))
        {
            ...
            for (int i = 0;i < listProviders.SelectedIndices.Count;i++)
            {
                ...
                whereProv += "'" + POut.Long(ProviderC.getListShort()[listProviders.SelectedIndices[i]].ProvNum) + "'";
            }
            whereProv += ") ";
            patStat = BuildPatStatList(checkActiveOnly.Checked);
            command = setPatientBaseSelect();
            command += "WHERE CONCAT(CONCAT(CONCAT(CONCAT(LName,', '),FName),' '),MiddleI) >= " + "'" + POut.String(textStartName.Text) + "'";
            command += " AND CONCAT(CONCAT(CONCAT(CONCAT(LName,', '),FName),' '),MiddleI) <= " + "'" + POut.String(textEndName.Text) + "'";
        ...
        if (__dummyScrutVar0.equals(1))
        {
            ...
            {
                if (StringSupport.equals(labInsCoStartAddr.Text, ""))
                {
        ...
        if (__dummyScrutVar0.equals(2))
        {
            ...
            CusCol = new DataColumn("Name", System.String.class);
            CusTable.Columns.Add(CusCol);
            CusCol = new DataColumn("Address", System.String.class);
            CusTable.Columns.Add(CusCol);
            CusCol = new DataColumn("Address2", System.String.class);
            CusTable.Columns.Add(CusCol);
            CusCol = new DataColumn("City", System.String.class);
            CusTable.Columns.Add(CusCol);
            CusCol = new DataColumn("State", System.String.class);
            CusTable.Columns.Add(CusCol);
            CusCol = new DataColumn("Zip", System.String.class);
            CusTable.Columns.Add(CusCol);
            String tmpString = "";
            for (Object __dummyForeachVar0 : listCusNames.Items)
            {
                Object CustomLabel = (Object)__dummyForeachVar0;
                tmpString = CustomLabel instanceof String ? (String)CustomLabel : (String)null;
        ...
        if (__dummyScrutVar0.equals(3))
        {
            ...
            command = setPatientBaseSelect();
            command += "WHERE SUBSTRING(Birthdate,6,5) >= '" + dateBirthdayFrom.ToString("MM-dd") + "' " + "AND SUBSTRING(Birthdate,6,5) <= '" + dateBirthdayTo.ToString("MM-dd") + "' " + "AND SUBSTRING(Birthdate,1,4) <> '0001' AND " + patStat + " ORDER BY LName,FName";
            buildLabelTable(command);
        }
        else
        {
    ...
    private static String setPatientBaseSelect() throws Exception {
        String command = new String();
        command = "SELECT patient.LName,patient.FName,patient.MiddleI,patient.Preferred," + "patient.Address,patient.Address2,patient.City,patient.State,patient.Zip, " + "patient.Guarantor," + "'' FamList ";
        //0-3
        //4-9
        //10
        //placeholder column: 11 for patient names and dates. If empty, then only single patient will print
    ...
    private String buildPatStatList(boolean Active) throws Exception {
        if (Active == true)
        {
        ...
        String patStat = new String();
        // used as the Patient Status portion
        ...
        for (int i = 0;i < listStatus.SelectedIndices.Count;i++)
        {
            ...
            {
                case 0: 
                    patStat += ((Enum)PatientStatus.Patient).ordinal();
                    break;
                case 1: 
                    patStat += ((Enum)PatientStatus.NonPatient).ordinal();
                    break;
                case 2: 
                    patStat += ((Enum)PatientStatus.Inactive).ordinal();
                    break;
                case 3: 
                    patStat += ((Enum)PatientStatus.Archived).ordinal();
                    break;
                case 4: 
                    patStat += ((Enum)PatientStatus.Deceased).ordinal();
                    break;
                case 5: 
                    patStat += ((Enum)PatientStatus.Prospective).ordinal();
                    break;
    ...
    private void buildLabelTable(String getData) throws Exception {
        AddrTable = Reports.getTable(getData);
        buildLabels();
    }

    private void addBlankLabels() throws Exception {
        int i = 0;
        int cnt = 0;
        String valType = "";
        while (cnt < iLabelStart)
        {
            ...
            for (Object __dummyForeachVar1 : AddrTable.Columns)
            {
                DataColumn col = (DataColumn)__dummyForeachVar1;
                colName[i] = col.ColumnName;
                valType = col.DataType.ToString();
                System.String __dummyScrutVar2 = valType;
                if (__dummyScrutVar2.equals("System.String"))
                {
                    AddrRow[colName[i]] = " ";
                }
                else
    ...
    private void buildLabels() throws Exception {
        if (AddrTable.Rows.Count > 0)
        {
            ...
            printPreview = new OpenDental.UI.FormPrintPreview(PrintSituation.LabelSheet, pd, (int)Math.Ceiling((double)AddrTable.Rows.Count / 30), 0, "Laser labels printed");
    ...
    private void pdLabels_PrintPage(Object sender, PrintPageEventArgs ev) throws Exception {
        ...
        {
            SelectedIndex __dummyScrutVar3 = tabLabelSetup.SelectedIndex;
            if (__dummyScrutVar3.equals(0) || __dummyScrutVar3.equals(3))
            {
                text = AddrTable.Rows[labelsPrinted]["FName"].ToString() + " " + AddrTable.Rows[labelsPrinted]["MiddleI"].ToString() + " " + AddrTable.Rows[labelsPrinted]["LName"].ToString() + "\r\n";
            }
            ...
            if (!StringSupport.equals(AddrTable.Rows[labelsPrinted]["Address2"].ToString(), ""))
            {
            ...
            text += AddrTable.Rows[labelsPrinted]["State"].ToString() + "   " + AddrTable.Rows[labelsPrinted]["Zip"].ToString() + "\r\n";
    ...
    //
    private void displayLabels(int istartingpoint) throws Exception {
        int x = 0;
        int y = 3;
        int cnt = 0;
        for (int i = 0;i < 10;i++)
        {
            for (int j = 0;j < 3;j++)
            {
                ...
                {
                    picLabel[cnt].Image = Resources.getdeleteX();
                }
                else
                {
                    picLabel[cnt].Image = Resources.getbutLabel();
                } 
    ...
    private void clickLabel(Object sender, EventArgs e) throws Exception {
    ...
    //
    private void displayPatStatus(int disTabIdx) throws Exception {
    ...
    //Patient Tab
    //
    private void checkActiveOnly_CheckedChanged(Object sender, EventArgs e) throws Exception {
    ...
    private void checkAllProviders_CheckedChanged(Object sender, EventArgs e) throws Exception {
    ...
    private void butStartName_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void butEndName_Click(Object sender, EventArgs e) throws Exception {
        FormPatientSelect FormPS = new FormPatientSelect();
        FormPS.SelectionModeOnly = true;
        FormPS.ShowDialog();
        if (FormPS.DialogResult != DialogResult.OK)
    ...
    //
    private void radioButSingle_CheckedChanged(Object sender, EventArgs e) throws Exception {
    ...
    private void radioButRange_CheckedChanged(Object sender, EventArgs e) throws Exception {
        labInsCoStart.Visible = true;
    ...
    private String fillFromInsCoList(long carrierNum) throws Exception {
    ...
    private void textInsCoStart_Click(Object sender, EventArgs e) throws Exception {
    }

    //insRange = 0;
    private void textInsCoEnd_Click(Object sender, EventArgs e) throws Exception {
    }

    //insRange = 1;
    private void butInsCo_Click(Object sender, EventArgs e) throws Exception {
    ...
    //Custom Tab
    //
    private void butCusAdd_Click(Object sender, EventArgs e) throws Exception {
    ...
    private void butCusRemove_Click(Object sender, EventArgs e) throws Exception {
        listCusNames.Items.RemoveAt(idxCus);
        butCusRemove.Visible = false;
    }

    private void listCusNames_SelectedIndexChanged(Object sender, EventArgs e) throws Exception {
    ...
    //Birthday Tab
    //
    private void checkBirthdayActive_CheckedChanged(Object sender, EventArgs e) throws Exception {
        displayPatStatus(tabLabelSetup.SelectedIndex);
    ...
    private void butBirthdayLeft_Click(Object sender, EventArgs e) throws Exception {
        ...
        if (toLastDay)
        {
            ...
            textBirthdayTo.Text = (new DateTime(dateTo.Year, dateTo.Month, CultureInfo.CurrentCulture.Calendar.GetDaysInMonth(dateTo.Year, dateTo.Month))).ToString(Lan.g(this,"MM/dd"));
        }
         
    }

    private void butBirthdayRight_Click(Object sender, EventArgs e) throws Exception {
        DateTime dateFrom = PIn.Date(textBirthdayFrom.Text);
        DateTime dateTo = PIn.Date(textBirthdayTo.Text);
    ...
    private void setNextMonth() throws Exception {
        textBirthdayFrom.Text = (new DateTime(DateTime.Today.AddMonths(1).Year, DateTime.Today.AddMonths(1).Month, 1)).ToString(Lan.g(this,"MM/dd"));
        textBirthdayTo.Text = (new DateTime(DateTime.Today.AddMonths(2).Year, DateTime.Today.AddMonths(2).Month, 1)).AddDays(-1).ToString(Lan.g(this,"MM/dd"));
    }

    private void butBirthdayMonth_Click(Object sender, EventArgs e) throws Exception {
        setNextMonth();
    }
