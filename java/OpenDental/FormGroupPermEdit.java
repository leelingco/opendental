...
* 
*/
public class FormGroupPermEdit  extends System.Windows.Forms.Form 
{
    ...
    private System.Windows.Forms.TextBox textDays = new System.Windows.Forms.TextBox();
    ...
    * 
    */
    public FormGroupPermEdit(GroupPermission cur) throws Exception {
        initializeComponent();
        Lan.f(this);
        Cur = cur.copy();
    }
    ...
    */
    ...
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormGroupPermEdit.class);
        ...
        this.label3.Text = "For instance, if you set days to 1, then user will only have permission if the da" + "te of the item is today";
        //
        // textDays
        //
    ...
    private void formGroupPermEdit_Load(Object sender, System.EventArgs e) throws Exception {
    ...
    private void textDate_KeyDown(Object sender, System.Windows.Forms.KeyEventArgs e) throws Exception {
        textDays.Text = "";
    }

    private void textDays_KeyDown(Object sender, System.Windows.Forms.KeyEventArgs e) throws Exception {
        textDate.Text = "";
