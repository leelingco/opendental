...
*/
public class FormProcTPEdit  extends System.Windows.Forms.Form 
{
    ...
    */
    ...
    private System.Windows.Forms.TextBox textToothNumTP = new System.Windows.Forms.TextBox();
    ...
    private OpenDental.ValidDouble textDiscount;
    private Label label2 = new Label();
    private OpenDental.ValidDouble textPatAmt;
    private Label label3 = new Label();
    private TextBox textPrognosis = new TextBox();
    private TextBox textDx = new TextBox();
    private Label labelDx = new Label();
    private DateTime DateTP = new DateTime();
    /**
    * 
    */
    public FormProcTPEdit(ProcTP procCur, DateTime dateTP) throws Exception {
        //
    ...
    */
    private void initializeComponent() throws Exception {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(FormProcTPEdit.class);
    ...
    private void formProcTPEdit_Load(Object sender, System.EventArgs e) throws Exception {
        ...
        for (int i = 0;i < DefC.getShort()[((Enum)DefCat.TxPriorities).ordinal()].Length;i++)
        {
            ...
            if (ProcCur.Priority == DefC.getShort()[((Enum)DefCat.TxPriorities).ordinal()][i].DefNum)
            {
        ...
        //already converted to international format before saved to db.
    ...
    private void butOK_Click(Object sender, System.EventArgs e) throws Exception {
        if (!StringSupport.equals(textFeeAmt.errorProvider1.GetError(textFeeAmt), "") || !StringSupport.equals(textPriInsAmt.errorProvider1.GetError(textPriInsAmt), "") || !StringSupport.equals(textSecInsAmt.errorProvider1.GetError(textSecInsAmt), "") || !StringSupport.equals(textDiscount.errorProvider1.GetError(textDiscount), "") || !StringSupport.equals(textPatAmt.errorProvider1.GetError(textPatAmt), ""))
        {
        ...
        ProcTPs.insertOrUpdate(ProcCur,false);
        //IsNew not applicable here
