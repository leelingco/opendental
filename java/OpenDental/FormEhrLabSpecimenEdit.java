...
public class FormEhrLabSpecimenEdit  extends Form 
{
    ...
    private void fillGridCondition() throws Exception {
        gridCondition.beginUpdate();
        gridCondition.getColumns().Clear();
        ODGridColumn col;
        col = new ODGridColumn("Description",80);
        gridCondition.getColumns().add(col);
        gridCondition.getRows().Clear();
        OpenDental.UI.ODGridRow row;
        for (int i = 0;i < EhrLabSpecimenCur.getListEhrLabSpecimenCondition().Count;i++)
        {
            row = new OpenDental.UI.ODGridRow();
            if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionText, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionText);
            }
            else if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionTextAlt, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionTextAlt);
            }
            else if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionTextOriginal, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenCondition()[i].SpecimenConditionTextOriginal);
            }
            else
            {
                row.getCells().add("Unkown Condition Code.");
            }   
            //should never happen
            gridCondition.getRows().add(row);
        }
        gridCondition.endUpdate();
    }

    private void fillGridReject() throws Exception {
        gridReject.beginUpdate();
        gridReject.getColumns().Clear();
        ODGridColumn col;
        col = new ODGridColumn("Description",80);
        gridReject.getColumns().add(col);
        gridReject.getRows().Clear();
        OpenDental.UI.ODGridRow row;
        for (int i = 0;i < EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason().Count;i++)
        {
            row = new OpenDental.UI.ODGridRow();
            if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonText, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonText);
            }
            else if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonTextAlt, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonTextAlt);
            }
            else if (!StringSupport.equals(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonTextOriginal, ""))
            {
                row.getCells().Add(EhrLabSpecimenCur.getListEhrLabSpecimenRejectReason()[i].SpecimenRejectReasonTextOriginal);
            }
            else
            {
                row.getCells().add("Unkown Reject Reason Code.");
            }   
            //should never happen
            gridReject.getRows().add(row);
        }
    ...
    */
    private void initializeComponent() throws Exception {
        ...
        // gridReject
        //
        this.gridReject.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
        this.gridReject.setHScrollVisible(false);
        this.gridReject.Location = new System.Drawing.Point(292, 12);
        this.gridReject.Name = "gridReject";
        this.gridReject.setScrollValue(0);
        this.gridReject.Size = new System.Drawing.Size(295, 166);
        this.gridReject.TabIndex = 11;
        this.gridReject.setTitle("Reject Reasons");
        this.gridReject.setTranslationName(null);
        //
        // gridCondition
        //
        this.gridCondition.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right)));
        this.gridCondition.setHScrollVisible(false);
        this.gridCondition.Location = new System.Drawing.Point(292, 185);
        this.gridCondition.Name = "gridCondition";
        this.gridCondition.setScrollValue(0);
        this.gridCondition.Size = new System.Drawing.Size(295, 166);
        this.gridCondition.TabIndex = 5;
        this.gridCondition.setTitle("Condition Codes");
        this.gridCondition.setTranslationName(null);
        //
    ...
    private OpenDental.UI.ODGrid gridReject;
    ...
    private System.Windows.Forms.TextBox textSpecimenTypeCodeSystemNameAlt = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label43 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textSpecimenTypeCodeSystemName = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.Label label14 = new System.Windows.Forms.Label();
    private System.Windows.Forms.TextBox textSpecimenTypeText = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textSpecimenTypeID = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox textSpecimenTypeTextOriginal = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.TextBox textSpecimenTypeTextAlt = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textSpecimenTypeIDAlt = new System.Windows.Forms.TextBox();
    private System.Windows.Forms.GroupBox groupBox8 = new System.Windows.Forms.GroupBox();
    private System.Windows.Forms.TextBox textCollectionDateTimeStart = new System.Windows.Forms.TextBox();
    ...
    private System.Windows.Forms.TextBox textCollectionDateTimeEnd = new System.Windows.Forms.TextBox();
}
